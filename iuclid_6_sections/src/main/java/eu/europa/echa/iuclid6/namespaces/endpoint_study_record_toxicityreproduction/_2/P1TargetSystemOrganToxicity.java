...
public class P1TargetSystemOrganToxicity {

    protected List<TargetSystemOrganToxicityP1Entry> entry;
     ...
     * {@link TargetSystemOrganToxicityP1Entry }
     * 
     * 
     */
    public List<TargetSystemOrganToxicityP1Entry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<TargetSystemOrganToxicityP1Entry>();
        }
        return this.entry;
    }
