...
public class EfficacyPerformanceAssessment {

    protected List<EfficacyPerformanceAssessmentEntry> entry;
     ...
     * {@link EfficacyPerformanceAssessmentEntry }
     * 
     * 
     */
    public List<EfficacyPerformanceAssessmentEntry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<EfficacyPerformanceAssessmentEntry>();
        }
        return this.entry;
    }
