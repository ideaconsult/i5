...
public class AttachedBackgroundMaterial {

    protected List<AttachedBackgroundMaterialEntry> entry;
     ...
     * {@link AttachedBackgroundMaterialEntry }
     * 
     * 
     */
    public List<AttachedBackgroundMaterialEntry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<AttachedBackgroundMaterialEntry>();
        }
        return this.entry;
    }
