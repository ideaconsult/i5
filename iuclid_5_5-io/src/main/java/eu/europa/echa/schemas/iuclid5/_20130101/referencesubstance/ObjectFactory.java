 ...
 * generated in the eu.europa.echa.schemas.iuclid5._20130101.referencesubstance package. 
...
public class ObjectFactory {
    ...
    private final static QName _ReferenceSubstanceReferenceSubstanceInformationDataProtectionRegulatoryPurposesRegulatoryPurposeOtherValue_QNAME = new QName("http://echa.europa.eu/schemas/iuclid5/20130101", "otherValue");
    private final static QName _ReferenceSubstanceModificationHistoryModificationModificationBy_QNAME = new QName("http://echa.europa.eu/schemas/iuclid5/20130101", "modificationBy");
    private final static QName _ReferenceSubstanceModificationHistoryModificationComment_QNAME = new QName("http://echa.europa.eu/schemas/iuclid5/20130101", "comment");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: eu.europa.echa.schemas.iuclid5._20130101.referencesubstance
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://echa.europa.eu/schemas/iuclid5/20130101", name = "otherValue", scope = ReferenceSubstance.ReferenceSubstanceInformation.DataProtection.RegulatoryPurposes.RegulatoryPurpose.class)
    public JAXBElement<String> createReferenceSubstanceReferenceSubstanceInformationDataProtectionRegulatoryPurposesRegulatoryPurposeOtherValue(String value) {
        return new JAXBElement<String>(_ReferenceSubstanceReferenceSubstanceInformationDataProtectionRegulatoryPurposesRegulatoryPurposeOtherValue_QNAME, String.class, ReferenceSubstance.ReferenceSubstanceInformation.DataProtection.RegulatoryPurposes.RegulatoryPurpose.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://echa.europa.eu/schemas/iuclid5/20130101", name = "otherValue", scope = ReferenceSubstance.ReferenceSubstanceInformation.CasInformation.AlternativeCASInfos.AlternativeCASInfo.Justification.class)
    public JAXBElement<String> createReferenceSubstanceReferenceSubstanceInformationCasInformationAlternativeCASInfosAlternativeCASInfoJustificationOtherValue(String value) {
        return new JAXBElement<String>(_ReferenceSubstanceReferenceSubstanceInformationDataProtectionRegulatoryPurposesRegulatoryPurposeOtherValue_QNAME, String.class, ReferenceSubstance.ReferenceSubstanceInformation.CasInformation.AlternativeCASInfos.AlternativeCASInfo.Justification.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://echa.europa.eu/schemas/iuclid5/20130101", name = "modificationBy", scope = ReferenceSubstance.ModificationHistory.Modification.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://echa.europa.eu/schemas/iuclid5/20130101", name = "comment", scope = ReferenceSubstance.ModificationHistory.Modification.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://echa.europa.eu/schemas/iuclid5/20130101", name = "otherValue", scope = ReferenceSubstance.ReferenceSubstanceStructure.DataProtection.RegulatoryPurposes.RegulatoryPurpose.class)
    public JAXBElement<String> createReferenceSubstanceReferenceSubstanceStructureDataProtectionRegulatoryPurposesRegulatoryPurposeOtherValue(String value) {
        return new JAXBElement<String>(_ReferenceSubstanceReferenceSubstanceInformationDataProtectionRegulatoryPurposesRegulatoryPurposeOtherValue_QNAME, String.class, ReferenceSubstance.ReferenceSubstanceStructure.DataProtection.RegulatoryPurposes.RegulatoryPurpose.class, value);
    }
