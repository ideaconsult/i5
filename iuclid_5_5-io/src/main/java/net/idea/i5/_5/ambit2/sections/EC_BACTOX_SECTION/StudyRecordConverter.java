...
public class StudyRecordConverter
	extends
	ECOTOXStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20130101.studyrecord.EC_BACTOX_SECTION.EndpointStudyRecord> {
	...
	eu.europa.echa.schemas.iuclid5._20130101.studyrecord.EC_BACTOX_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled
		.getScientificPart();
	...
	if (sciPart.getECBACTOX().getGUIDELINE() != null)
	    for (eu.europa.echa.schemas.iuclid5._20130101.studyrecord.EC_BACTOX_SECTION.EndpointStudyRecord.ScientificPart.ECBACTOX.GUIDELINE.Set set : sciPart
	...
	if (sciPart.getECBACTOX().getEFFCONC() != null && sciPart.getECBACTOX().getEFFCONC().getSet() != null)
	    for (eu.europa.echa.schemas.iuclid5._20130101.studyrecord.EC_BACTOX_SECTION.EndpointStudyRecord.ScientificPart.ECBACTOX.EFFCONC.Set set : sciPart
