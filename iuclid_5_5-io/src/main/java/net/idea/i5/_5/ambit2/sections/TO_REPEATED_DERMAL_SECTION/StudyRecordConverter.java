...
public class StudyRecordConverter extends
		TOXStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20130101.studyrecord.TO_REPEATED_DERMAL_SECTION.EndpointStudyRecord> {
	...
	protected String getTestMaterialIdentity(EndpointStudyRecord unmarshalled) {
		try {
			return unmarshalled.getScientificPart().getTOREPEATEDDERMAL().getTESTMATINDICATOR().getSet()
	...
	protected void parseReference(EndpointStudyRecord unmarshalled, ProtocolApplication papp)
		...
		if (unmarshalled.getScientificPart().getTOREPEATEDDERMAL().getREFERENCE() != null)
			for (eu.europa.echa.schemas.iuclid5._20130101.studyrecord.TO_REPEATED_DERMAL_SECTION.EndpointStudyRecord.ScientificPart.TOREPEATEDDERMAL.REFERENCE.Set set : unmarshalled
					.getScientificPart().getTOREPEATEDDERMAL().getREFERENCE().getSet()) {
				try {
				...
				try {
					...
					isReferenceTypeAccepted(set.getPHRASEOTHERREFERENCETYPE() == null ? null
							: set.getPHRASEOTHERREFERENCETYPE().getREFERENCETYPE());
					return;
	...
	public IStructureRecord transform2record(EndpointStudyRecord unmarshalled, SubstanceRecord record)
		...
		if (super.transform2record(unmarshalled, record) == null)
			return null;
		eu.europa.echa.schemas.iuclid5._20130101.studyrecord.TO_REPEATED_DERMAL_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled
				.getScientificPart();
		if (sciPart.getTOREPEATEDDERMAL() == null)
			return null;
		...
		parseReliability(papp, unmarshalled.getReliability().getValueID(), unmarshalled.isRobustStudy(),
				unmarshalled.isUsedForClassification(), unmarshalled.isUsedForMSDS(),
		...
		if (sciPart.getTOREPEATEDDERMAL().getMETHODNOGUIDELINE() != null)
			try {
				papp.getProtocol().addGuideline(sciPart.getTOREPEATEDDERMAL().getMETHODNOGUIDELINE().getSet()
		...
		try {
			String medium = sciPart.getTOREPEATEDDERMAL().getTYPECOVERAGE().getSet().getPHRASEOTHERLISTPOP()
					.getLISTPOPValue();
			if (medium.startsWith("other:"))
				medium = sciPart.getTOREPEATEDDERMAL().getTYPECOVERAGE().getSet().getPHRASEOTHERLISTPOP()
		...
		/*
		 * try { papp.getParameters().put(cRouteAdm,
		 * sciPart.getTOREPEATEDDERMAL().getROUTE()==null?null:
		 * sciPart.getTOREPEATEDDERMAL().getROUTE().getSet().
		 * getPHRASEOTHERLISTPOP().getLISTPOPValue()); } catch (Exception x) {
		 * papp.getParameters().put(cRouteAdm,null);}
		 */

		StringBuilder doses = null;
		if (sciPart.getTOREPEATEDDERMAL().getDOSES() != null
				&& sciPart.getTOREPEATEDDERMAL().getDOSES().getSet() != null)
			for (eu.europa.echa.schemas.iuclid5._20130101.studyrecord.TO_REPEATED_DERMAL_SECTION.EndpointStudyRecord.ScientificPart.TOREPEATEDDERMAL.DOSES.Set set : sciPart
					.getTOREPEATEDDERMAL().getDOSES().getSet()) {
				if (doses == null)
					doses = new StringBuilder();
				else
					doses.append(";");
		...
		if (sciPart.getTOREPEATEDDERMAL().getEFFLEVEL() != null)
			for (eu.europa.echa.schemas.iuclid5._20130101.studyrecord.TO_REPEATED_DERMAL_SECTION.EndpointStudyRecord.ScientificPart.TOREPEATEDDERMAL.EFFLEVEL.Set set : sciPart
					.getTOREPEATEDDERMAL().getEFFLEVEL().getSet()) {
				EffectRecord<String, IParams, String> effect = endpointCategory.createEffectRecord();
				try {
					effect.setEndpoint(getValue(set.getPHRASEOTHERENDPOINT().getENDPOINTValue(),
				...
				if (set.getPRECISIONLOQUALIFIER() != null) {
					...
					if (set.getPRECISIONLOQUALIFIER().getLOVALUE() != null)
						try {
							effect.setLoValue(
									Double.parseDouble(set.getPRECISIONLOQUALIFIER().getLOVALUE().getValue()));
					...
					if (set.getPRECISIONLOQUALIFIER().getUPVALUE() != null)
						try {
							effect.setUpValue(
									Double.parseDouble(set.getPRECISIONLOQUALIFIER().getUPVALUE().getValue()));
				...
				try {
					effect.getConditions().put(I5CONSTANTS.cSpecies,
							getValue(
									sciPart.getTOREPEATEDDERMAL().getORGANISM().getSet().getPHRASEOTHERLISTPOP()
											.getLISTPOPValue(),
									sciPart.getTOREPEATEDDERMAL().getORGANISM().getSet().getPHRASEOTHERLISTPOP()
											.getLISTPOPTXT()));
				} catch (Exception x) {
				...
				try {
					effect.getConditions().put(I5CONSTANTS.cTestType,
							getValue(
									sciPart.getTOREPEATEDDERMAL().getTESTTYPETOX().getSet().getPHRASEOTHERLISTPOP()
											.getLISTPOPValue(),
									sciPart.getTOREPEATEDDERMAL().getTESTTYPETOX().getSet().getPHRASEOTHERLISTPOP()
											.getLISTPOPTXT()));
				} catch (Exception x) {
