...
public class Experiment<PROTOCOLPARAMS extends IParams,CONDITIONS extends IParams> 
			extends ProtocolApplication<Protocol, PROTOCOLPARAMS, String, CONDITIONS, String> {
	...
	public String generateJSONSchema() throws Exception {
		...
		MySchemaFactoryWrapper visitor = new MySchemaFactoryWrapper();
		mapper.acceptJsonFormatVisitor(mapper.constructType(getClass()), visitor);
...
class MySchemaFactoryWrapper extends SchemaFactoryWrapper {
	...
	public MySchemaFactoryWrapper() {
		super(new MySchemaFactoryWrapperFactory());
	}
    
	@Override
	public JsonMapFormatVisitor expectMapFormat(JavaType type)
			throws JsonMappingException {
		JsonMapFormatVisitor visitor =  (JsonMapFormatVisitor) super.expectMapFormat(type);
        
        return visitor;
	}
	
	  private void addProperty(JsonSchema s, JavaType type)
	   {
