...
public class StudyRecordConverter
	...
	try {
	    return unmarshalled.getScientificPart().getENSTABILITYINSOIL().getTESTMATINDICATOR().getSet()
	...
	if (sciPart.getENSTABILITYINSOIL().getGUIDELINE() != null)
	    for (ScientificPart.ENSTABILITYINSOIL.GUIDELINE.Set set : sciPart.getENSTABILITYINSOIL().getGUIDELINE()
		    .getSet()) {
	...
	if (sciPart.getENSTABILITYINSOIL().getMETHODNOGUIDELINE() != null)
	    try {
		papp.getProtocol().addGuideline(
			sciPart.getENSTABILITYINSOIL().getMETHODNOGUIDELINE().getSet().getTEXTAREABELOW()
	...
	papp.getParameters().put(
		...
		sciPart.getENSTABILITYINSOIL().getOXYGENCONDITIONS() == null ? null : sciPart.getENSTABILITYINSOIL()
			.getOXYGENCONDITIONS().getSet().getPHRASEOTHERLISTPOPFIX().getLISTPOPFIXValue());
	...
	if (sciPart.getENSTABILITYINSOIL().getPROP() != null)
		...
		Params p = new Params();
		p.put(I5CONSTANTS.cSoilType, set.getPHRASEOTHERSOILTYPE() == null ? null : set.getPHRASEOTHERSOILTYPE()
			.getSOILTYPEValue());
