...
public enum I5_ROOT_OBJECTS implements IROOT_OBJECTS {
  ...
  AGGLOMERATION_AGGREGATION {
    ...
    @Override
    public String[] getEndpoints() {
      return new String[] { I5CONSTANTS.AGGLO_AGGR_DIAM, I5CONSTANTS.AGGLO_AGGR_SIZE, I5CONSTANTS.AGGLO_AGGR_SIZE_DIST,
    ...
    @Override
    public String[] getProtocolParameters() {
      return new String[] { I5CONSTANTS.pMETHODDETAILS, I5CONSTANTS.pDATA_GATHERING_INSTRUMENTS, I5CONSTANTS.pSAMPLING,
  ...
  CRYSTALLINE_PHASE {
    ...
    public String[] getProtocolParameters() {
      return new String[] { I5CONSTANTS.pMETHODDETAILS, I5CONSTANTS.pDATA_GATHERING_INSTRUMENTS, I5CONSTANTS.pSAMPLING,
          I5CONSTANTS.cTypeMethod, I5CONSTANTS.pTESTMAT_FORM, I5CONSTANTS.pMATERIAL_ISOTROPIC };
    }
  ...
  SPECIFIC_SURFACE_AREA {
    ...
    public String[] getProtocolParameters() {
      return new String[] { I5CONSTANTS.pMETHODDETAILS, I5CONSTANTS.pDATA_GATHERING_INSTRUMENTS, I5CONSTANTS.pSAMPLING,
          I5CONSTANTS.pTESTMAT_FORM, I5CONSTANTS.cTypeMethod };
    }
  ...
  DUSTINESS {
    ...
    public String[] getProtocolParameters() {
      return new String[] { I5CONSTANTS.pMETHODDETAILS, I5CONSTANTS.pDATA_GATHERING_INSTRUMENTS, I5CONSTANTS.pSAMPLING,
          I5CONSTANTS.cTypeMethod, I5CONSTANTS.pTESTMAT_FORM };
    }
  ...
  EC_FISHTOX {
    ...
    public String[] getEndpoints() {
      ...
      return new String[] { "LC0", "LC10", "LC50", "LC100", "EC0", "EC10", "EC50", "EC100", "LL0", "LL10", "LL50",
          "LL100", "EL0", "EL10", "EL50", "EL100", "IC10", "IC50", "IC100", "NOELR", "LOELR", "NOEC", "LOEC" };
    }
  ...
  EC_CHRONFISHTOX {
    ...
    public String[] getEndpoints() {
      // phrasegroup_E115b
      return new String[] { "NOEC", "LOEC", "NOELR", "LOELR", "EC10", "EC50", "EL10", "EL50", "IC10", "IC50", "LC10",
          "LC50", "LL10", "LL50" };
    }
  ...
  EC_ALGAETOX {
    ...
    public String[] getEndpoints() {
      // phrasegroup_E110
      return new String[] { "EC0", "EC5", "EC10", "EC20", "EC50", "EC90", "EC100", "EL0", "EL5", "EL10", "EL20", "EL50",
          "EL90", "EL100", "IC10", "IC50", "IC100", "NOEC", "NOELR", "LOEC", "LOELR" };
    }
  ...
  TO_REPEATED_ORAL {
    ...
    public String[] getEndpoints() {
      return new String[] {
          // phrasegroup_T156
          "NOAEL", "NOEL", "LOAEL", "LOEL", "BMD05", "BMDL05", "BMDL10", "BMD", "BMC05", "BMCL05", "BMCL10", "BMC",
  ...
  TO_CARCINOGENICITY {
    ...
    public String[] getEndpoints() {
      return new String[] { // phrasegroup_TD400
          ...
          "LOAEC", "LOAEL", "LOEC", "LOEL", "BMD05", "BMDL05", "BMDL10", "BMD", "BMC05", "BMCL05", "BMCL10", "BMC",
          "dose level", "conc.level", "other:" };
    }
