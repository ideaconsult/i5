...
public enum I5_ROOT_OBJECTS {
	...
	@Override
	public String[] getConditions() {
	    return new String[] { I5CONSTANTS.rCRYSTALLINE_PHASE_SPACE_GROUP,
		    I5CONSTANTS.rCRYSTALLINE_PHASE_POINT_GROUP, I5CONSTANTS.rCRYSTALLINE_PHASE_CRYSTGRPH_PLANES,
		    I5CONSTANTS.rCRYSTALLINE_PHASE_BRAVAIS_LATTICE, I5CONSTANTS.rCRYSTALLINE_PHASE_COMMON_NAME,
	...
	public String[] getEndpoints() {
	    // phrasegroup_E104
	    return new String[] { "LC0", "LC10", "LC50", "LC100", "EC0", "EC10", "EC50", "EC100", "LL0", "LL10",
		    "LL50", "LL100", "EL0", "EL10", "EL50", "EL100", "IC10", "IC50", "IC100", "NOELR", "LOELR", "NOEC",
		    "LOEC" };
	}
	...
	public String[] getEndpoints() {
	    // phrasegroup_E121
	    return new String[] { "NOEC", "LOEC", "EC0", "EC10", "EC25", "EC50", "EC100", "ER0", "ER10", "ER25",
		    "ER50", "ER100", "LC0", "LC10", "LC25", "LC50", "LC100"
	...
	@Override
	public String[] getProtocolParameters() {
	    return new String[] { I5CONSTANTS.cRouteAdm, I5CONSTANTS.cDoses, I5CONSTANTS.cSpecies,
	...
	@Override
	public String[] getProtocolParameters() {
	    return new String[] { I5CONSTANTS.cTypeCoverage, I5CONSTANTS.cDoses, I5CONSTANTS.cSpecies,
		    I5CONSTANTS.cTestType };
	}
	...
	@Override
	public String[] getConditions() {
	    return new String[] { I5CONSTANTS.cMetabolicActivation, I5CONSTANTS.cSpecies };
	}
	...
	public String[] getEndpoints() {
	    ...
	    "no NOAEC identified", "no NOAEL identified", "no T25 identified", "T25", "NOAEC", "NOAEL", "NOEC", "NOEL",
		    "LOAEC", "LOAEL", "LOEC", "LOEL", "BMD05", "BMDL05", "BMDL10", "BMD", "BMC05", "BMCL05", "BMCL10",
		    "BMC", "dose level", "conc.level", "other:" };
	}
