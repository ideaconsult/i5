...
public class PhotoCatalyticActivity_RecordWrapper
  ...
  public void assignEffectLevels(ProtocolApplication papp, ENDPOINTSTUDYRECORDPhotocatalyticActivity studyrecord) {
    ...
    for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_photocatalyticactivity._5.ENDPOINTSTUDYRECORDPhotocatalyticActivity.ResultsAndDiscussion.TurnOverFrequency.Entry entry : studyrecord
