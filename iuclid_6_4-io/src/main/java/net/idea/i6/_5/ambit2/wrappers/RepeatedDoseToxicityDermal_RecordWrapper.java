...
public class RepeatedDoseToxicityDermal_RecordWrapper
	...
	public void assignEffectLevels(ProtocolApplication papp,
		...
		if (studyrecord.getResultsAndDiscussion().getTargetSystemOrganToxicity() != null) {
			for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_repeateddosetoxicitydermal._5.ENDPOINTSTUDYRECORDRepeatedDoseToxicityDermal.ResultsAndDiscussion.TargetSystemOrganToxicitySet.TargetSystemOrganToxicity.Entry entry : studyrecord
