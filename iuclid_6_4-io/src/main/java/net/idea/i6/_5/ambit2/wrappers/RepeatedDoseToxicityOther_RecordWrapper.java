...
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_repeateddosetoxicityother._5.ENDPOINTSTUDYRECORDRepeatedDoseToxicityOther;
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_repeateddosetoxicityother._5.ENDPOINTSTUDYRECORDRepeatedDoseToxicityOther.ResultsAndDiscussion.EffectLevels.Efflevel.Entry;
...
public class RepeatedDoseToxicityOther_RecordWrapper
	...
	public void assignEffectLevels(ProtocolApplication papp, ENDPOINTSTUDYRECORDRepeatedDoseToxicityOther studyrecord) {
		...
		if (studyrecord.getResultsAndDiscussion().getTargetSystemOrganToxicity() != null) {
			for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_repeateddosetoxicityother._5.ENDPOINTSTUDYRECORDRepeatedDoseToxicityOther.ResultsAndDiscussion.TargetSystemOrganToxicitySet.TargetSystemOrganToxicity.Entry entry : studyrecord.getResultsAndDiscussion().getTargetSystemOrganToxicity()
