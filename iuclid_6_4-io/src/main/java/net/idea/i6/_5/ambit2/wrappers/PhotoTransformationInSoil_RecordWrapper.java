...
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_phototransformationinsoil._5.ENDPOINTSTUDYRECORDPhotoTransformationInSoil;
...
public class PhotoTransformationInSoil_RecordWrapper
	...
	public void assignEffectLevels(ProtocolApplication papp, ENDPOINTSTUDYRECORDPhotoTransformationInSoil studyrecord) {
		...
		if (studyrecord.getResultsAndDiscussion().getDissipationHalfLife() != null) {
			for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_phototransformationinsoil._5.ENDPOINTSTUDYRECORDPhotoTransformationInSoil.ResultsAndDiscussion.DissipationHalfLife.Entry e : studyrecord.getResultsAndDiscussion().getDissipationHalfLife().getEntry()) {
				EffectRecord<String, IParams, String> effect = endpointCategory.createEffectRecord();
