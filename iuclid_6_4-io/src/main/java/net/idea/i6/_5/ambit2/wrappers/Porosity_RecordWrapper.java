...
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_porosity._5.ENDPOINTSTUDYRECORDPorosity;
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_porosity._5.ENDPOINTSTUDYRECORDPorosity.ResultsAndDiscussion.Porosity.Entry;
...
public class Porosity_RecordWrapper extends EndpointStudyRecordWrapper<ENDPOINTSTUDYRECORDPorosity> {
  ...
  public void assignEffectLevels(ProtocolApplication papp, ENDPOINTSTUDYRECORDPorosity studyrecord) {
    ...
    if (studyrecord.getResultsAndDiscussion().getSpecificPoreVolume() != null)
      for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_porosity._5.ENDPOINTSTUDYRECORDPorosity.ResultsAndDiscussion.SpecificPoreVolume.Entry entry : studyrecord
    ...
    if (studyrecord.getResultsAndDiscussion().getModalPoreDiameter() != null)
      ;
    for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_porosity._5.ENDPOINTSTUDYRECORDPorosity.ResultsAndDiscussion.ModalPoreDiameter.Entry entry : studyrecord
