...
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_repeateddosetoxicityoral._6.ENDPOINTSTUDYRECORDRepeatedDoseToxicityOral;
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_repeateddosetoxicityoral._6.ENDPOINTSTUDYRECORDRepeatedDoseToxicityOral.ResultsAndDiscussion.EffectLevels.Efflevel.Entry;
...
public class RepeatedDoseToxicityOral_RecordWrapper
	...
	public void assignEffectLevels(ProtocolApplication papp, ENDPOINTSTUDYRECORDRepeatedDoseToxicityOral studyrecord) {
		...
		if (studyrecord.getResultsAndDiscussion().getTargetSystemOrganToxicity() != null) {
			for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_repeateddosetoxicityoral._6.ENDPOINTSTUDYRECORDRepeatedDoseToxicityOral.ResultsAndDiscussion.TargetSystemOrganToxicitySet.TargetSystemOrganToxicity.Entry entry : studyrecord.getResultsAndDiscussion().getTargetSystemOrganToxicity()
