...
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_zetapotential._6.ENDPOINTSTUDYRECORDZetaPotential;
...
public class ZetaPotential_RecordWrapper extends EndpointStudyRecordWrapper<ENDPOINTSTUDYRECORDZetaPotential> {
  ...
  public void assignEffectLevels(ProtocolApplication papp, ENDPOINTSTUDYRECORDZetaPotential studyrecord) {
    ...
    if (studyrecord.getResultsAndDiscussion().getZetaPotential() != null)
      for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_zetapotential._6.ENDPOINTSTUDYRECORDZetaPotential.ResultsAndDiscussion.ZetaPotential.Entry entry : studyrecord
    ...
    if (studyrecord.getResultsAndDiscussion().getIsoElectricPoint() != null)
      for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_zetapotential._6.ENDPOINTSTUDYRECORDZetaPotential.ResultsAndDiscussion.IsoElectricPoint.Entry entry : studyrecord
