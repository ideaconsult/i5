...
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_phototransformation._6.ENDPOINTSTUDYRECORDPhototransformation;
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_phototransformation._6.ENDPOINTSTUDYRECORDPhototransformation.ResultsAndDiscussion.Degradation.Entry.SamplingTime;
...
public class Phototransformation_RecordWrapper
  ...
  public void assignEffectLevels(ProtocolApplication papp, ENDPOINTSTUDYRECORDPhototransformation studyrecord) {
    ...
    if (studyrecord.getResultsAndDiscussion().getDegradation() != null) {
      ...
      for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_phototransformation._6.ENDPOINTSTUDYRECORDPhototransformation.ResultsAndDiscussion.Degradation.Entry e : studyrecord
    ...
    if (studyrecord.getResultsAndDiscussion().getDissipationParentCompound() != null) {
      for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_phototransformation._6.ENDPOINTSTUDYRECORDPhototransformation.ResultsAndDiscussion.DissipationParentCompound.Entry e : studyrecord
