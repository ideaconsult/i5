...
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_skinsensitisation._6.ENDPOINTSTUDYRECORDSkinSensitisation;
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_skinsensitisation._6.ENDPOINTSTUDYRECORDSkinSensitisation.ResultsAndDiscussion.InVivoLLNA.Results.Entry.Value;
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_skinsensitisation._6.ENDPOINTSTUDYRECORDSkinSensitisation.ResultsAndDiscussion.TraditionalSensitisationTest.ResultsOfTest.Entry;
...
public class SkinSensitisation_RecordWrapper extends EndpointStudyRecordWrapper<ENDPOINTSTUDYRECORDSkinSensitisation> {
  ...
  public void assignEffectLevels(ProtocolApplication papp, ENDPOINTSTUDYRECORDSkinSensitisation studyRecord) {
    ...
    if (studyRecord.getResultsAndDiscussion().getInVitroInChemico() != null)
      for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_skinsensitisation._6.ENDPOINTSTUDYRECORDSkinSensitisation.ResultsAndDiscussion.InVitroInChemico.Results.Entry e : studyRecord
    ...
    if (studyRecord.getResultsAndDiscussion().getInVivoLLNA() != null) {
      for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_skinsensitisation._6.ENDPOINTSTUDYRECORDSkinSensitisation.ResultsAndDiscussion.InVivoLLNA.Results.Entry e : studyRecord
