...
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_carcinogenicity._6.ENDPOINTSTUDYRECORDCarcinogenicity;
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_carcinogenicity._6.ENDPOINTSTUDYRECORDCarcinogenicity.ResultsAndDiscussion.EffectLevels.Efflevel.Entry;
...
public class Carcinogenicity_RecordWrapper
	...
	public void assignEffectLevels(ProtocolApplication papp, ENDPOINTSTUDYRECORDCarcinogenicity studyrecord) {
		...
		if (studyrecord.getResultsAndDiscussion().getTargetSystemOrganToxicity() != null) {
			for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_carcinogenicity._6.ENDPOINTSTUDYRECORDCarcinogenicity.ResultsAndDiscussion.TargetSystemOrganToxicitySet.TargetSystemOrganToxicity.Entry entry : studyrecord.getResultsAndDiscussion()
