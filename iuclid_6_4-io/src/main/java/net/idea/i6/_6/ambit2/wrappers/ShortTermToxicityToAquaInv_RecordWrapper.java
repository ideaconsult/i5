...
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_shorttermtoxicitytoaquainv._6.ENDPOINTSTUDYRECORDShortTermToxicityToAquaInv;
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_shorttermtoxicitytoaquainv._6.ENDPOINTSTUDYRECORDShortTermToxicityToAquaInv.ResultsAndDiscussion.EffectConcentrations.Entry;
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_shorttermtoxicitytoaquainv._6.ENDPOINTSTUDYRECORDShortTermToxicityToAquaInv.ResultsAndDiscussion.EffectConcentrations.Entry.Duration;
import eu.europa.echa.iuclid6.namespaces.platform_container.v1.Document;
import net.idea.i6._6.ambit2.EndpointStudyRecordWrapper;

public class ShortTermToxicityToAquaInv_RecordWrapper
    extends EndpointStudyRecordWrapper<ENDPOINTSTUDYRECORDShortTermToxicityToAquaInv> {

  public ShortTermToxicityToAquaInv_RecordWrapper(Document doc) throws Exception {
    super(doc);
  }
  ...
  @Override
  public void assignEffectLevels(ProtocolApplication papp, ENDPOINTSTUDYRECORDShortTermToxicityToAquaInv studyrecord) {
