...
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_developmentaltoxicityteratogenicity._6.ENDPOINTSTUDYRECORDDevelopmentalToxicityTeratogenicity;
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_developmentaltoxicityteratogenicity._6.ENDPOINTSTUDYRECORDDevelopmentalToxicityTeratogenicity.ResultsAndDiscussion.DevelopmentalToxicitySet.DevelopmentalToxicity.Entry.LowestEffectiveDoseConc;
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_developmentaltoxicityteratogenicity._6.ENDPOINTSTUDYRECORDDevelopmentalToxicityTeratogenicity.ResultsAndDiscussion.ResultsMaternalAnimals.EffectLevelsMaternalAnimals.Efflevel.Entry;
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_developmentaltoxicityteratogenicity._6.ENDPOINTSTUDYRECORDDevelopmentalToxicityTeratogenicity.ResultsAndDiscussion.ResultsMaternalAnimals.EffectLevelsMaternalAnimals.Efflevel.Entry.Basis;
  ...
  public void assignEffectLevels(ambit2.base.data.study.ProtocolApplication papp,
    ...
    if (studyrecord.getResultsAndDiscussion().getResultsFetuses() != null) {
      if (studyrecord.getResultsAndDiscussion().getResultsFetuses().getEffectLevelsFetuses() != null)
        for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_developmentaltoxicityteratogenicity._6.ENDPOINTSTUDYRECORDDevelopmentalToxicityTeratogenicity.ResultsAndDiscussion.ResultsFetuses.EffectLevelsFetuses.Efflevel.Entry e : studyrecord
          ...
          StringBuilder basis4effectlevel = null;
          if (e.getBasis() != null)
            for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_developmentaltoxicityteratogenicity._6.ENDPOINTSTUDYRECORDDevelopmentalToxicityTeratogenicity.ResultsAndDiscussion.ResultsFetuses.EffectLevelsFetuses.Efflevel.Entry.Basis b : e
                .getBasis()) {
              if (basis4effectlevel == null)
                basis4effectlevel = new StringBuilder();
              else
    ...
    if (studyrecord.getResultsAndDiscussion().getDevelopmentalToxicity() != null) {
      if (studyrecord.getResultsAndDiscussion().getDevelopmentalToxicity().getDevelopmentalToxicity() != null)
        for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_developmentaltoxicityteratogenicity._6.ENDPOINTSTUDYRECORDDevelopmentalToxicityTeratogenicity.ResultsAndDiscussion.DevelopmentalToxicitySet.DevelopmentalToxicity.Entry entry : studyrecord
