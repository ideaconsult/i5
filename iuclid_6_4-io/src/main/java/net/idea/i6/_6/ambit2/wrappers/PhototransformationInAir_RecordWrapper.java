...
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_phototransformationinair._6.ENDPOINTSTUDYRECORDPhototransformationInAir;
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_phototransformationinair._6.ENDPOINTSTUDYRECORDPhototransformationInAir.ResultsAndDiscussion.DegradationRateConstant.Entry;
import eu.europa.echa.iuclid6.namespaces.platform_container.v1.Document;
import net.idea.i6._6.ambit2.EndpointStudyRecordWrapper;

public class PhototransformationInAir_RecordWrapper
    extends EndpointStudyRecordWrapper<ENDPOINTSTUDYRECORDPhototransformationInAir> {
  ...
  public void assignEffectLevels(ProtocolApplication papp, ENDPOINTSTUDYRECORDPhototransformationInAir studyrecord) {
    ...
    if (studyrecord.getResultsAndDiscussion().getDegradationRateConstant() != null) {
      ...
      for (Entry e : studyrecord.getResultsAndDiscussion().getDegradationRateConstant().getEntry()) {
        ...
        if (reactant == null)
          ...
          reactant.append(", ");
        reactant.append(p2Value(e.getReactionWith()));
      }
    }
    try {
    ...
    if (studyrecord.getResultsAndDiscussion().getDissipationParentCompound() != null) {
      for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_phototransformationinair._6.ENDPOINTSTUDYRECORDPhototransformationInAir.ResultsAndDiscussion.DissipationParentCompound.Entry e : studyrecord
        ...
        effect.getConditions().put(I5CONSTANTS.TestCondition, joinMultiTextFieldSmall(e.getTestCondition()));
