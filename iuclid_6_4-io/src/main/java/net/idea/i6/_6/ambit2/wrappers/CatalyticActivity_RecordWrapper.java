...
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_catalyticactivity._6.ENDPOINTSTUDYRECORDCatalyticActivity;
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_catalyticactivity._6.ENDPOINTSTUDYRECORDCatalyticActivity.ResultsAndDiscussion.PhotocatalyticActivity.Entry;
...
public class CatalyticActivity_RecordWrapper
  ...
  public void assignEffectLevels(ProtocolApplication papp, ENDPOINTSTUDYRECORDCatalyticActivity studyrecord) {
    ...
    if (studyrecord.getResultsAndDiscussion().getFrequency() != null)
      for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_catalyticactivity._6.ENDPOINTSTUDYRECORDCatalyticActivity.ResultsAndDiscussion.Frequency.Entry entry : studyrecord
