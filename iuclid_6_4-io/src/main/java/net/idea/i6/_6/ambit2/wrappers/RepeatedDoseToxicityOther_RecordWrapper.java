...
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_repeateddosetoxicityoral._6.ENDPOINTSTUDYRECORDRepeatedDoseToxicityOral.ResultsAndDiscussion.TargetSystemOrganToxicitySet.TargetSystemOrganToxicity.Entry.LowestEffectiveDoseConc;
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_repeateddosetoxicityother._6.ENDPOINTSTUDYRECORDRepeatedDoseToxicityOther;
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_repeateddosetoxicityother._6.ENDPOINTSTUDYRECORDRepeatedDoseToxicityOther.ResultsAndDiscussion.EffectLevels.Efflevel.Entry;
import eu.europa.echa.iuclid6.namespaces.platform_container.v1.Document;

public class RepeatedDoseToxicityOther_RecordWrapper
		extends RepeatedDoseToxicity_RecordWrapper<ENDPOINTSTUDYRECORDRepeatedDoseToxicityOther> {

	public RepeatedDoseToxicityOther_RecordWrapper(Document doc) throws Exception {
		super(doc);
	}
	...
	@Override
	public void assignEffectLevels(ProtocolApplication papp, ENDPOINTSTUDYRECORDRepeatedDoseToxicityOther studyrecord) {
		...
		if (studyrecord.getResultsAndDiscussion().getTargetSystemOrganToxicity() != null) {
			for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_repeateddosetoxicityother._6.ENDPOINTSTUDYRECORDRepeatedDoseToxicityOther.ResultsAndDiscussion.TargetSystemOrganToxicitySet.TargetSystemOrganToxicity.Entry entry : studyrecord.getResultsAndDiscussion().getTargetSystemOrganToxicity()
