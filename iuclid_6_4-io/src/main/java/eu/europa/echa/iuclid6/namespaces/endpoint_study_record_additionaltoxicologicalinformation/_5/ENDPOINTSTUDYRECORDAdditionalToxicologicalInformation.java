...
// Generated on: 2020.11.25 at 04:38:21 PM EET 
//


package eu.europa.echa.iuclid6.namespaces.endpoint_study_record_additionaltoxicologicalinformation._5;
 ...
 *                           &lt;sequence>
 *                             &lt;element name="value" type="{http://iuclid6.echa.europa.eu/namespaces/oecd/v5}PG6_60327" minOccurs="0"/>
...
public class ENDPOINTSTUDYRECORDAdditionalToxicologicalInformation {
    ...
    public static class AdministrativeData {
        ...
        @XmlElementRef(name = "RobustStudy", namespace = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-AdditionalToxicologicalInformation/5.0", type = JAXBElement.class, required = false)
        protected JAXBElement<Boolean> robustStudy;
        @XmlElementRef(name = "UsedForClassification", namespace = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-AdditionalToxicologicalInformation/5.0", type = JAXBElement.class, required = false)
        protected JAXBElement<Boolean> usedForClassification;
        @XmlElementRef(name = "UsedForMSDS", namespace = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-AdditionalToxicologicalInformation/5.0", type = JAXBElement.class, required = false)
