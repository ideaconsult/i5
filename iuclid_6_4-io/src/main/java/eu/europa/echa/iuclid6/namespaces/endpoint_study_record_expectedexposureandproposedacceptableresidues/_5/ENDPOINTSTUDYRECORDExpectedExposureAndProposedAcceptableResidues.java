 ...
 *                           &lt;sequence>
 *                             &lt;element name="value" type="{http://iuclid6.echa.europa.eu/namespaces/oecd/v5}PG6_60354" minOccurs="0"/>
...
public class ENDPOINTSTUDYRECORDExpectedExposureAndProposedAcceptableResidues {
    ...
    public static class AdministrativeData {
        ...
        @XmlElementRef(name = "RobustStudy", namespace = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-ExpectedExposureAndProposedAcceptableResidues/5.0", type = JAXBElement.class, required = false)
        protected JAXBElement<Boolean> robustStudy;
        @XmlElementRef(name = "UsedForClassification", namespace = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-ExpectedExposureAndProposedAcceptableResidues/5.0", type = JAXBElement.class, required = false)
        protected JAXBElement<Boolean> usedForClassification;
        @XmlElementRef(name = "UsedForMSDS", namespace = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-ExpectedExposureAndProposedAcceptableResidues/5.0", type = JAXBElement.class, required = false)
