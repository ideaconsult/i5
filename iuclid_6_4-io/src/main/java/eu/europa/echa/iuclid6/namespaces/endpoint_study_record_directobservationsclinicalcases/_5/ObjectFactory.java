 ...
 * generated in the eu.europa.echa.iuclid6.namespaces.endpoint_study_record_directobservationsclinicalcases._5 package. 
...
public class ObjectFactory {
    ...
    private final static QName _ENDPOINTSTUDYRECORDDirectObservationsClinicalCasesAdministrativeDataUsedForClassification_QNAME = new QName("http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-DirectObservationsClinicalCases/5.0", "UsedForClassification");
    private final static QName _ENDPOINTSTUDYRECORDDirectObservationsClinicalCasesAdministrativeDataUsedForMSDS_QNAME = new QName("http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-DirectObservationsClinicalCases/5.0", "UsedForMSDS");
    private final static QName _ENDPOINTSTUDYRECORDDirectObservationsClinicalCasesAdministrativeDataRobustStudy_QNAME = new QName("http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-DirectObservationsClinicalCases/5.0", "RobustStudy");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: eu.europa.echa.iuclid6.namespaces.endpoint_study_record_directobservationsclinicalcases._5
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-DirectObservationsClinicalCases/5.0", name = "UsedForClassification", scope = ENDPOINTSTUDYRECORDDirectObservationsClinicalCases.AdministrativeData.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-DirectObservationsClinicalCases/5.0", name = "UsedForMSDS", scope = ENDPOINTSTUDYRECORDDirectObservationsClinicalCases.AdministrativeData.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-DirectObservationsClinicalCases/5.0", name = "RobustStudy", scope = ENDPOINTSTUDYRECORDDirectObservationsClinicalCases.AdministrativeData.class)
