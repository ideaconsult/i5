...
@XmlRootElement(name = "ASSESSMENT_ENTITY.GroupOfConstituentInTheRegisteredSubstance")
public class ASSESSMENTENTITYGroupOfConstituentInTheRegisteredSubstance {

    @XmlElement(name = "AssessmentEntityConfidentialityClaim")
    protected ASSESSMENTENTITYGroupOfConstituentInTheRegisteredSubstance.AssessmentEntityConfidentialityClaim assessmentEntityConfidentialityClaim;
    ...
    protected ASSESSMENTENTITYGroupOfConstituentInTheRegisteredSubstance.EndpointSummariesList endpointSummariesList;
     ...
     * @return
     *     possible object is
     *     {@link ASSESSMENTENTITYGroupOfConstituentInTheRegisteredSubstance.AssessmentEntityConfidentialityClaim }
     *     
     */
    public ASSESSMENTENTITYGroupOfConstituentInTheRegisteredSubstance.AssessmentEntityConfidentialityClaim getAssessmentEntityConfidentialityClaim() {
     ...
     *     
     */
    public void setAssessmentEntityConfidentialityClaim(ASSESSMENTENTITYGroupOfConstituentInTheRegisteredSubstance.AssessmentEntityConfidentialityClaim value) {
     ...
     * @return
     *     possible object is
     *     {@link ASSESSMENTENTITYGroupOfConstituentInTheRegisteredSubstance.EndpointSummariesList }
     *     
     */
    public ASSESSMENTENTITYGroupOfConstituentInTheRegisteredSubstance.EndpointSummariesList getEndpointSummariesList() {
     ...
     *     
     */
    public void setEndpointSummariesList(ASSESSMENTENTITYGroupOfConstituentInTheRegisteredSubstance.EndpointSummariesList value) {
        ...
        extends BaseDataProtectionField
    {
        ...
        protected List<ASSESSMENTENTITYGroupOfConstituentInTheRegisteredSubstance.AssessmentEntityConfidentialityClaim.Legislation> legislation;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link ASSESSMENTENTITYGroupOfConstituentInTheRegisteredSubstance.AssessmentEntityConfidentialityClaim.Legislation }
         * 
         * 
         */
        public List<ASSESSMENTENTITYGroupOfConstituentInTheRegisteredSubstance.AssessmentEntityConfidentialityClaim.Legislation> getLegislation() {
            if (legislation == null) {
                legislation = new ArrayList<ASSESSMENTENTITYGroupOfConstituentInTheRegisteredSubstance.AssessmentEntityConfidentialityClaim.Legislation>();
            }
    ...
    public static class EndpointSummariesList {
        ...
        protected List<ASSESSMENTENTITYGroupOfConstituentInTheRegisteredSubstance.EndpointSummariesList.Entry> entry;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link ASSESSMENTENTITYGroupOfConstituentInTheRegisteredSubstance.EndpointSummariesList.Entry }
         * 
         * 
         */
        public List<ASSESSMENTENTITYGroupOfConstituentInTheRegisteredSubstance.EndpointSummariesList.Entry> getEntry() {
            if (entry == null) {
                entry = new ArrayList<ASSESSMENTENTITYGroupOfConstituentInTheRegisteredSubstance.EndpointSummariesList.Entry>();
            }
            return this.entry;
        }
