package net.idea.i5._4.ambit2.sections.TO_GENETIC_IN_VIVO_SECTION;
...
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_GENETIC_IN_VIVO_SECTION.DocumentTypeType;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_GENETIC_IN_VIVO_SECTION.EndpointStudyRecord;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_GENETIC_IN_VIVO_SECTION.EndpointStudyRecord.ScientificPart.TOGENETICINVIVO.GUIDELINE.Set;



public class StudyRecordConverter extends TOXStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_GENETIC_IN_VIVO_SECTION.EndpointStudyRecord>{
	...
	protected void parseReference(EndpointStudyRecord unmarshalled, ProtocolApplication papp) throws QACriteriaException {
		...
		if (unmarshalled.getScientificPart().getTOGENETICINVIVO().getREFERENCE() != null)
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_GENETIC_IN_VIVO_SECTION.EndpointStudyRecord.ScientificPart.TOGENETICINVIVO.REFERENCE.Set set : unmarshalled.getScientificPart().getTOGENETICINVIVO().getREFERENCE().getSet()) {
				try {
	...
	public IStructureRecord transform2record(EndpointStudyRecord unmarshalled, SubstanceRecord record) throws AmbitException {
		...
		eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_GENETIC_IN_VIVO_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled.getScientificPart();
