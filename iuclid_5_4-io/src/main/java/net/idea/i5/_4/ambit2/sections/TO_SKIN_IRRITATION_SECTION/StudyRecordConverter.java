...
public class StudyRecordConverter
		extends
		TOXStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_SKIN_IRRITATION_SECTION.EndpointStudyRecord> {
	...
	protected void parseReference(EndpointStudyRecord unmarshalled,
		...
		if (unmarshalled.getScientificPart().getTOSKINIRRITATION()
				.getREFERENCE() != null)
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_SKIN_IRRITATION_SECTION.EndpointStudyRecord.ScientificPart.TOSKINIRRITATION.REFERENCE.Set set : unmarshalled
	...
	public IStructureRecord transform2record(EndpointStudyRecord unmarshalled,
		...
		if (super.transform2record(unmarshalled, record) == null)
			return null;
		eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_SKIN_IRRITATION_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled
				.getScientificPart();
		...
		if (sciPart.getTOSKINIRRITATION().getOVERALLRS() != null) {
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_SKIN_IRRITATION_SECTION.EndpointStudyRecord.ScientificPart.TOSKINIRRITATION.OVERALLRS.Set set : sciPart
		...
		if (papp.getInterpretationResult() == null || "".equals(papp.getInterpretationResult()))
			try {
				papp.setInterpretationResult(sciPart.getTOSKINIRRITATION()
