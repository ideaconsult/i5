...
public class StudyRecordConverter
		extends
		TOXStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_EYE_IRRITATION_SECTION.EndpointStudyRecord> {
	...
	protected void parseReference(EndpointStudyRecord unmarshalled,
		...
		if (unmarshalled.getScientificPart().getTOEYEIRRITATION()
				.getREFERENCE() != null)
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_EYE_IRRITATION_SECTION.EndpointStudyRecord.ScientificPart.TOEYEIRRITATION.REFERENCE.Set set : unmarshalled
	...
	public IStructureRecord transform2record(EndpointStudyRecord unmarshalled,
		...
		if (super.transform2record(unmarshalled, record) == null)
			return null;
		eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_EYE_IRRITATION_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled
				.getScientificPart();
		...
		if (sciPart.getTOEYEIRRITATION().getOVERALLRS() != null) {
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_EYE_IRRITATION_SECTION.EndpointStudyRecord.ScientificPart.TOEYEIRRITATION.OVERALLRS.Set set : sciPart
