package net.idea.i5._4.ambit2.sections.TO_DEVELOPMENTAL_SECTION;
...
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_DEVELOPMENTAL_SECTION.DocumentTypeType;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_DEVELOPMENTAL_SECTION.EndpointStudyRecord;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_DEVELOPMENTAL_SECTION.EndpointStudyRecord.ScientificPart.TODEVELOPMENTAL.GUIDELINE.Set;


public class StudyRecordConverter extends TOXStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_DEVELOPMENTAL_SECTION.EndpointStudyRecord>{
	...
	protected void parseReference(EndpointStudyRecord unmarshalled, ProtocolApplication papp) throws QACriteriaException {
		...
		if (unmarshalled.getScientificPart().getTODEVELOPMENTAL().getREFERENCE() != null)
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_DEVELOPMENTAL_SECTION.EndpointStudyRecord.ScientificPart.TODEVELOPMENTAL.REFERENCE.Set set : unmarshalled.getScientificPart().getTODEVELOPMENTAL().getREFERENCE().getSet()) {
				try {
	...
	public IStructureRecord transform2record(EndpointStudyRecord unmarshalled, SubstanceRecord record) throws AmbitException {
		...
		eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_DEVELOPMENTAL_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled.getScientificPart();
		...
		for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_DEVELOPMENTAL_SECTION.EndpointStudyRecord.ScientificPart.TODEVELOPMENTAL.DOSES.Set set : sciPart.getTODEVELOPMENTAL().getDOSES().getSet()) {
		...
		if (sciPart.getTODEVELOPMENTAL().getEFFLEVEL() != null)
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_DEVELOPMENTAL_SECTION.EndpointStudyRecord.ScientificPart.TODEVELOPMENTAL.EFFLEVEL.Set set : sciPart.getTODEVELOPMENTAL().getEFFLEVEL().getSet()) {
