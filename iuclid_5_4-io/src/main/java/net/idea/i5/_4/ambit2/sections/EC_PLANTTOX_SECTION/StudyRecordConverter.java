package net.idea.i5._4.ambit2.sections.EC_PLANTTOX_SECTION;
...
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_PLANTTOX_SECTION.DocumentTypeType;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_PLANTTOX_SECTION.EndpointStudyRecord;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_PLANTTOX_SECTION.EndpointStudyRecord.ScientificPart.ECPLANTTOX.REFERENCE.Set;

public class StudyRecordConverter
	extends
	ECOTOXStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_PLANTTOX_SECTION.EndpointStudyRecord> {
	...
	if (super.transform2record(unmarshalled, record) == null)
	    return null;
	eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_PLANTTOX_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled
		.getScientificPart();
	...
	if (sciPart.getECPLANTTOX().getGUIDELINE() != null)
	    for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_PLANTTOX_SECTION.EndpointStudyRecord.ScientificPart.ECPLANTTOX.GUIDELINE.Set set : sciPart
	...
	if (sciPart.getECPLANTTOX().getEFFCONC() != null && sciPart.getECPLANTTOX().getEFFCONC().getSet() != null)
	    for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_PLANTTOX_SECTION.EndpointStudyRecord.ScientificPart.ECPLANTTOX.EFFCONC.Set set : sciPart
