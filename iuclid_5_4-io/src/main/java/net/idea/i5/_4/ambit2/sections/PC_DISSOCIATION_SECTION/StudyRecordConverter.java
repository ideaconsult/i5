package net.idea.i5._4.ambit2.sections.PC_DISSOCIATION_SECTION;
...
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.PC_DISSOCIATION_SECTION.DocumentTypeType;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.PC_DISSOCIATION_SECTION.EndpointStudyRecord;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.PC_DISSOCIATION_SECTION.EndpointStudyRecord.ScientificPart;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.PC_DISSOCIATION_SECTION.EndpointStudyRecord.ScientificPart.PCDISSOCIATION.REFERENCE.Set;
...
public class StudyRecordConverter
	extends
	PChemStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.PC_DISSOCIATION_SECTION.EndpointStudyRecord, IParams, IParams> {
	...
	if (super.transform2record(unmarshalled, record) == null)
	    return null;
	eu.europa.echa.schemas.iuclid5._20120101.studyrecord.PC_DISSOCIATION_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled
		.getScientificPart();
	...
	if (sciPart.getPCDISSOCIATION().getPKA() != null && sciPart.getPCDISSOCIATION().getPKA().getSet() != null)
	    for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.PC_DISSOCIATION_SECTION.EndpointStudyRecord.ScientificPart.PCDISSOCIATION.PKA.Set set : sciPart
