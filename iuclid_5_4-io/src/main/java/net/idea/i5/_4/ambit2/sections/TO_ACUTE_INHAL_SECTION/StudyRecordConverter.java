package net.idea.i5._4.ambit2.sections.TO_ACUTE_INHAL_SECTION;
...
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_ACUTE_INHAL_SECTION.DocumentTypeType;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_ACUTE_INHAL_SECTION.EndpointStudyRecord;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_ACUTE_INHAL_SECTION.EndpointStudyRecord.ScientificPart.TOACUTEINHAL.GUIDELINE.Set;
...
public class StudyRecordConverter
		extends
		TOXStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_ACUTE_INHAL_SECTION.EndpointStudyRecord> {
	...
	protected String getTestMaterialIdentity(EndpointStudyRecord unmarshalled) {
		try {
			return unmarshalled.getScientificPart().getTOACUTEINHAL()
	...
	protected void parseReference(EndpointStudyRecord unmarshalled,
		...
		if (unmarshalled.getScientificPart().getTOACUTEINHAL().getREFERENCE() != null)
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_ACUTE_INHAL_SECTION.EndpointStudyRecord.ScientificPart.TOACUTEINHAL.REFERENCE.Set set : unmarshalled
					.getScientificPart().getTOACUTEINHAL().getREFERENCE()
					.getSet()) {
				try {
	...
	public IStructureRecord transform2record(EndpointStudyRecord unmarshalled,
		...
		if (super.transform2record(unmarshalled, record) == null)
			return null;
		eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_ACUTE_INHAL_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled
				.getScientificPart();
		if (sciPart.getTOACUTEINHAL() == null)
			return null;
		...
		if (sciPart.getTOACUTEINHAL().getMETHODNOGUIDELINE() != null)
			try {
				papp.getProtocol().addGuideline(
						sciPart.getTOACUTEINHAL().getMETHODNOGUIDELINE()
		...
		Object prm_sex = null;
		try {
			prm_sex = sciPart.getTOACUTEINHAL().getSEX() == null ? null
					: sciPart.getTOACUTEINHAL().getSEX().getSet()
		...
		if (sciPart.getTOACUTEINHAL().getEFFLEVEL() != null)
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_ACUTE_INHAL_SECTION.EndpointStudyRecord.ScientificPart.TOACUTEINHAL.EFFLEVEL.Set set : sciPart
					.getTOACUTEINHAL().getEFFLEVEL().getSet()) {
				...
				try {
					effect.getConditions().put(
							...
							getValue(sciPart.getTOACUTEINHAL().getORGANISM()
									.getSet().getPHRASEOTHERLISTPOP()
									.getLISTPOPValue(), sciPart
									.getTOACUTEINHAL().getORGANISM().getSet()
		...
		if (sciPart.getTOACUTEINHAL().getINTERPRETRSSUBMITTER() != null) {
			...
			try {
				otherValue = sciPart.getTOACUTEINHAL()
			...
			setInterpretationResult(papp, sciPart.getTOACUTEINHAL()
					.getINTERPRETRSSUBMITTER().getSet()
		...
		if (sciPart.getTOACUTEINHAL().getCRITERIASUBMITTER() != null) {
			papp.setInterpretationCriteria(getValue(sciPart.getTOACUTEINHAL()
					.getCRITERIASUBMITTER().getSet().getPHRASEOTHERLISTPOP()
					.getLISTPOPValue(), sciPart.getTOACUTEINHAL()
					.getCRITERIASUBMITTER().getSet().getPHRASEOTHERLISTPOP()
					.getLISTPOPTXT()));
		} else
