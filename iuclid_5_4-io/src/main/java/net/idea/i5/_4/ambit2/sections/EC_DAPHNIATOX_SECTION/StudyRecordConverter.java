package net.idea.i5._4.ambit2.sections.EC_DAPHNIATOX_SECTION;
...
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_DAPHNIATOX_SECTION.DocumentTypeType;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_DAPHNIATOX_SECTION.EndpointStudyRecord;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_DAPHNIATOX_SECTION.EndpointStudyRecord.ScientificPart.ECDAPHNIATOX.REFERENCE.Set;
...
public class StudyRecordConverter
	extends
	ECOTOXStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_DAPHNIATOX_SECTION.EndpointStudyRecord> {
	...
	try {
	    return unmarshalled.getScientificPart().getECDAPHNIATOX().getTESTMATINDICATOR().getSet().getLISTBELOWSEL()
		    .getLISTBELOWSEL();
	} catch (Exception x) {
	    return null;
	}
	...
	if (super.transform2record(unmarshalled, record) == null)
	    return null;
	eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_DAPHNIATOX_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled
		.getScientificPart();
	if (sciPart.getECDAPHNIATOX() == null)
	    return null;
	...
	if (sciPart.getECDAPHNIATOX().getGUIDELINE() != null)
	    for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_DAPHNIATOX_SECTION.EndpointStudyRecord.ScientificPart.ECDAPHNIATOX.GUIDELINE.Set set : sciPart
		    .getECDAPHNIATOX().getGUIDELINE().getSet())
		try {
	...
	if (sciPart.getECDAPHNIATOX().getMETHODNOGUIDELINE() != null)
	    try {
		papp.getProtocol().addGuideline(
			sciPart.getECDAPHNIATOX().getMETHODNOGUIDELINE().getSet().getTEXTAREABELOW().getTEXTAREABELOW()
				.getValue());
	    } catch (Exception x) {
	    }
	...
	if (sciPart.getECDAPHNIATOX().getEXPDURATION() != null) {
	    Value p = new Value();
	    try {
		p.setLoValue(sciPart.getECDAPHNIATOX().getEXPDURATION().getSet().getVALUEUNITVALUE().getVALUE()
			.getValue());
	    } catch (Exception x) {
		p.setLoValue(null);
	    }
	...
	if (sciPart.getECDAPHNIATOX().getWATERTYPE() != null) {
	    papp.getParameters().put(I5CONSTANTS.cTestMedium,
		    sciPart.getECDAPHNIATOX().getWATERTYPE().getSet().getLISTRIGHTPOP().getLISTRIGHTPOPValue());
	} else
	...
	try {
	    papp.getParameters().put(
		    ...
		    getValue(
			    sciPart.getECDAPHNIATOX().getORGANISM().getSet().getPHRASEOTHERLISTPOP().getLISTPOPValue(),
	...
	if (sciPart.getECDAPHNIATOX().getEFFCONC() != null && sciPart.getECDAPHNIATOX().getEFFCONC().getSet() != null)
	    for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_DAPHNIATOX_SECTION.EndpointStudyRecord.ScientificPart.ECDAPHNIATOX.EFFCONC.Set set : sciPart
		    .getECDAPHNIATOX().getEFFCONC().getSet()) {
