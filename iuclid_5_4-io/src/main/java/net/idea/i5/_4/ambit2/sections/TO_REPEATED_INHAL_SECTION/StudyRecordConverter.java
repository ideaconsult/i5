package net.idea.i5._4.ambit2.sections.TO_REPEATED_INHAL_SECTION;
...
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPEATED_INHAL_SECTION.DocumentTypeType;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPEATED_INHAL_SECTION.EndpointStudyRecord;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPEATED_INHAL_SECTION.EndpointStudyRecord.ScientificPart.TOREPEATEDINHAL.GUIDELINE.Set;
...
public class StudyRecordConverter extends TOXStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPEATED_INHAL_SECTION.EndpointStudyRecord>{
	...
	protected void parseReference(EndpointStudyRecord unmarshalled, ProtocolApplication papp) throws QACriteriaException {
		...
		if (unmarshalled.getScientificPart().getTOREPEATEDINHAL().getREFERENCE() != null)
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPEATED_INHAL_SECTION.EndpointStudyRecord.ScientificPart.TOREPEATEDINHAL.REFERENCE.Set set : unmarshalled.getScientificPart().getTOREPEATEDINHAL().getREFERENCE().getSet()) {
				try {
	...
	public IStructureRecord transform2record(EndpointStudyRecord unmarshalled, SubstanceRecord record) throws AmbitException {
		...
		eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPEATED_INHAL_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled.getScientificPart();
		...
		*/
		...
		for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPEATED_INHAL_SECTION.EndpointStudyRecord.ScientificPart.TOREPEATEDINHAL.DOSES.Set set : sciPart.getTOREPEATEDINHAL().getDOSES().getSet()) {
		...
		if (sciPart.getTOREPEATEDINHAL().getEFFLEVEL() != null)
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPEATED_INHAL_SECTION.EndpointStudyRecord.ScientificPart.TOREPEATEDINHAL.EFFLEVEL.Set set : sciPart.getTOREPEATEDINHAL().getEFFLEVEL().getSet()) {
