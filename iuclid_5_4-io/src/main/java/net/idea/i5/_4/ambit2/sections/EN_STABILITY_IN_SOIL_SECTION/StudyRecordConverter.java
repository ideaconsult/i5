package net.idea.i5._4.ambit2.sections.EN_STABILITY_IN_SOIL_SECTION;
...
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EN_STABILITY_IN_SOIL_SECTION.DocumentTypeType;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EN_STABILITY_IN_SOIL_SECTION.EndpointStudyRecord;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EN_STABILITY_IN_SOIL_SECTION.EndpointStudyRecord.ScientificPart;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EN_STABILITY_IN_SOIL_SECTION.EndpointStudyRecord.ScientificPart.ENSTABILITYINSOIL.REFERENCE.Set;

public class StudyRecordConverter
		extends
		ENVFATEStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EN_STABILITY_IN_SOIL_SECTION.EndpointStudyRecord> {
	...
	protected String getTestMaterialIdentity(EndpointStudyRecord unmarshalled) {
		try {
			return unmarshalled.getScientificPart().getENSTABILITYINSOIL()
	...
	protected void parseReference(EndpointStudyRecord unmarshalled,
		...
		if (unmarshalled.getScientificPart().getENSTABILITYINSOIL()
				.getREFERENCE() != null)
	...
	public IStructureRecord transform2record(EndpointStudyRecord unmarshalled,
		...
		if (super.transform2record(unmarshalled, record) == null)
			return null;
		eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EN_STABILITY_IN_SOIL_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled
				.getScientificPart();
		if (sciPart.getENSTABILITYINSOIL() == null)
			return null;
		...
		if (sciPart.getENSTABILITYINSOIL().getGUIDELINE() != null)
			for (ScientificPart.ENSTABILITYINSOIL.GUIDELINE.Set set : sciPart
					.getENSTABILITYINSOIL().getGUIDELINE().getSet()) {
		...
		if (sciPart.getENSTABILITYINSOIL().getMETHODNOGUIDELINE() != null)
			try {
				papp.getProtocol().addGuideline(
						sciPart.getENSTABILITYINSOIL().getMETHODNOGUIDELINE()
		...
		try {
			papp.getParameters()
					.put(I5CONSTANTS.cTestType,
							sciPart.getENSTABILITYINSOIL()
									.getOXYGENCONDITIONS() == null ? null
									: sciPart.getENSTABILITYINSOIL()
											.getOXYGENCONDITIONS().getSet()
		...
		if (sciPart.getENSTABILITYINSOIL().getPROP() != null)
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EN_STABILITY_IN_SOIL_SECTION.EndpointStudyRecord.ScientificPart.ENSTABILITYINSOIL.PROP.Set set : sciPart
					.getENSTABILITYINSOIL().getPROP().getSet()) {
				Params p = new Params();
				p.put(I5CONSTANTS.cSoilType,
						set.getPHRASEOTHERSOILTYPE() == null ? null : set
								.getPHRASEOTHERSOILTYPE().getSOILTYPEValue());

				Value v = new Value();
				try {
					v.setLoQualifier(set.getPRECISIONCARBONLOQUALIFIER()
							.getCARBONLOQUALIFIERValue());
				} catch (Exception x) {
				}
				try {
					v.setLoValue(set.getPRECISIONCARBONLOQUALIFIER()
							.getCARBONLOVALUE().getValue());
				} catch (Exception x) {
					v.setLoValue(null);
				}
				try {
					v.setUpQualifier(set.getPRECISIONCARBONLOQUALIFIER()
							.getCARBONUPQUALIFIERValue());
				} catch (Exception x) {
				}
				try {
					v.setUpValue(set.getPRECISIONCARBONLOQUALIFIER()
							.getCARBONUPVALUE().getValue());
				} catch (Exception x) {
					v.setUpValue(null);
				}
				try {
				...
				if (set.getSOILNUMBER() != null
						&& set.getSOILNUMBER().getSOILNUMBERValue() != null) {
					p.put(I5CONSTANTS.cSoilNo, set.getSOILNUMBER()
							.getSOILNUMBERValue());
		...
		if (sciPart.getENSTABILITYINSOIL().getHALFLIFE() != null)
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EN_STABILITY_IN_SOIL_SECTION.EndpointStudyRecord.ScientificPart.ENSTABILITYINSOIL.HALFLIFE.Set set : sciPart
					.getENSTABILITYINSOIL().getHALFLIFE().getSet()) {
				EffectRecord<String, IParams, String> effect = endpointCategory
						.createEffectRecord();
				try {
					effect.setEndpoint(getValue(set.getPHRASEOTHERTYPE()
							.getTYPEValue(), set.getPHRASEOTHERTYPE()
							.getTYPETXT()));
				} catch (Exception x) {
				...
				try {
					IParams soilno = (Params) soil.get(set.getSOILNUMBER()
							.getSOILNUMBERValue());
