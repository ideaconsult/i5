package net.idea.i5._4.ambit2.sections.TO_REPRODUCTION_SECTION;
...
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPRODUCTION_SECTION.DocumentTypeType;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPRODUCTION_SECTION.EndpointStudyRecord;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPRODUCTION_SECTION.EndpointStudyRecord.ScientificPart.TOREPRODUCTION.GUIDELINE.Set;
...
public class StudyRecordConverter extends TOXStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPRODUCTION_SECTION.EndpointStudyRecord>{
	...
	protected void parseReference(EndpointStudyRecord unmarshalled, ProtocolApplication papp) throws QACriteriaException {
		...
		if (unmarshalled.getScientificPart().getTOREPRODUCTION().getREFERENCE() != null)
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPRODUCTION_SECTION.EndpointStudyRecord.ScientificPart.TOREPRODUCTION.REFERENCE.Set set : unmarshalled.getScientificPart().getTOREPRODUCTION().getREFERENCE().getSet()) {
				try {
	...
	public IStructureRecord transform2record(EndpointStudyRecord unmarshalled, SubstanceRecord record) throws AmbitException {
		...
		eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPRODUCTION_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled.getScientificPart();
		...
		*/
		...
		for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPRODUCTION_SECTION.EndpointStudyRecord.ScientificPart.TOREPRODUCTION.DOSES.Set set : sciPart.getTOREPRODUCTION().getDOSES().getSet()) try {
		...
		if (sciPart.getTOREPRODUCTION().getEFFLEVEL() != null)
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPRODUCTION_SECTION.EndpointStudyRecord.ScientificPart.TOREPRODUCTION.EFFLEVEL.Set set : sciPart.getTOREPRODUCTION().getEFFLEVEL().getSet()) {
