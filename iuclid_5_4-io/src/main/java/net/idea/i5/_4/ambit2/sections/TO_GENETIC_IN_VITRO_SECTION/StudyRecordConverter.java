package net.idea.i5._4.ambit2.sections.TO_GENETIC_IN_VITRO_SECTION;
...
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_GENETIC_IN_VITRO_SECTION.DocumentTypeType;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_GENETIC_IN_VITRO_SECTION.EndpointStudyRecord;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_GENETIC_IN_VITRO_SECTION.EndpointStudyRecord.ScientificPart.TOGENETICINVITRO.GUIDELINE.Set;
...
public class StudyRecordConverter extends TOXStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_GENETIC_IN_VITRO_SECTION.EndpointStudyRecord>{
	...
	protected void parseReference(EndpointStudyRecord unmarshalled, ProtocolApplication papp) throws QACriteriaException {
		...
		if (unmarshalled.getScientificPart().getTOGENETICINVITRO().getREFERENCE() != null)
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_GENETIC_IN_VITRO_SECTION.EndpointStudyRecord.ScientificPart.TOGENETICINVITRO.REFERENCE.Set set : unmarshalled.getScientificPart().getTOGENETICINVITRO().getREFERENCE().getSet()) {
				try {
	...
	public IStructureRecord transform2record(EndpointStudyRecord unmarshalled, SubstanceRecord record) throws AmbitException {
		...
		eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_GENETIC_IN_VITRO_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled.getScientificPart();
