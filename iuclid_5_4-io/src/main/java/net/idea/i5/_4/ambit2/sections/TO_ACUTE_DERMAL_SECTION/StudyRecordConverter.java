package net.idea.i5._4.ambit2.sections.TO_ACUTE_DERMAL_SECTION;
...
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_ACUTE_DERMAL_SECTION.DocumentTypeType;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_ACUTE_DERMAL_SECTION.EndpointStudyRecord;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_ACUTE_DERMAL_SECTION.EndpointStudyRecord.ScientificPart.TOACUTEDERMAL.GUIDELINE.Set;

public class StudyRecordConverter
		extends
		TOXStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_ACUTE_DERMAL_SECTION.EndpointStudyRecord> {
	...
	protected void parseReference(EndpointStudyRecord unmarshalled,
		...
		if (unmarshalled.getScientificPart().getTOACUTEDERMAL().getREFERENCE() != null)
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_ACUTE_DERMAL_SECTION.EndpointStudyRecord.ScientificPart.TOACUTEDERMAL.REFERENCE.Set set : unmarshalled
	...
	public IStructureRecord transform2record(EndpointStudyRecord unmarshalled,
		...
		if (super.transform2record(unmarshalled, record) == null)
			return null;
		eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_ACUTE_DERMAL_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled
				.getScientificPart();
		...
		if (sciPart.getTOACUTEDERMAL().getEFFLEVEL() != null)
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_ACUTE_DERMAL_SECTION.EndpointStudyRecord.ScientificPart.TOACUTEDERMAL.EFFLEVEL.Set set : sciPart
