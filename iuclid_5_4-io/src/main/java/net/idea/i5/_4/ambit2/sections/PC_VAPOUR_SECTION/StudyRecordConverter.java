package net.idea.i5._4.ambit2.sections.PC_VAPOUR_SECTION;
...
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.PC_VAPOUR_SECTION.DocumentTypeType;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.PC_VAPOUR_SECTION.EndpointStudyRecord;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.PC_VAPOUR_SECTION.EndpointStudyRecord.ScientificPart;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.PC_VAPOUR_SECTION.EndpointStudyRecord.ScientificPart.PCVAPOUR.REFERENCE.Set;

public class StudyRecordConverter
	extends
	PChemStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.PC_VAPOUR_SECTION.EndpointStudyRecord, IParams, IParams> {
	...
	if (super.transform2record(unmarshalled, record) == null)
	    return null;
	eu.europa.echa.schemas.iuclid5._20120101.studyrecord.PC_VAPOUR_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled
		.getScientificPart();
	 ...
	 * (eu.europa
	 * .echa.schemas.iuclid5._20120101.studyrecord.PC_VAPOUR_SECTION
	...
	if (sciPart.getPCVAPOUR().getVAPOURPR() != null && sciPart.getPCVAPOUR().getVAPOURPR().getSet() != null)
	    for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.PC_VAPOUR_SECTION.EndpointStudyRecord.ScientificPart.PCVAPOUR.VAPOURPR.Set set : sciPart
