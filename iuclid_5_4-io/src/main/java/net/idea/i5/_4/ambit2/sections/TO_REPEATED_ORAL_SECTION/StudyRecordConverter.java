package net.idea.i5._4.ambit2.sections.TO_REPEATED_ORAL_SECTION;
...
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPEATED_ORAL_SECTION.DocumentTypeType;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPEATED_ORAL_SECTION.EndpointStudyRecord;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPEATED_ORAL_SECTION.EndpointStudyRecord.ScientificPart.TOREPEATEDORAL.GUIDELINE.Set;


public class StudyRecordConverter extends TOXStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPEATED_ORAL_SECTION.EndpointStudyRecord>{
	...
	protected void parseReference(EndpointStudyRecord unmarshalled, ProtocolApplication papp) throws QACriteriaException {
		...
		if (unmarshalled.getScientificPart().getTOREPEATEDORAL().getREFERENCE() != null)
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPEATED_ORAL_SECTION.EndpointStudyRecord.ScientificPart.TOREPEATEDORAL.REFERENCE.Set set : unmarshalled.getScientificPart().getTOREPEATEDORAL().getREFERENCE().getSet()) {
				try {
	...
	public IStructureRecord transform2record(EndpointStudyRecord unmarshalled, SubstanceRecord record) throws AmbitException {
		...
		eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPEATED_ORAL_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled.getScientificPart();
		...
		*/
		...
		for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPEATED_ORAL_SECTION.EndpointStudyRecord.ScientificPart.TOREPEATEDORAL.DOSES.Set set : sciPart.getTOREPEATEDORAL().getDOSES().getSet()) try {
		...
		if (sciPart.getTOREPEATEDORAL().getEFFLEVEL() != null)
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_REPEATED_ORAL_SECTION.EndpointStudyRecord.ScientificPart.TOREPEATEDORAL.EFFLEVEL.Set set : sciPart.getTOREPEATEDORAL().getEFFLEVEL().getSet()) {
