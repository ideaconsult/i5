package net.idea.i5._4.ambit2.sections.EC_SOIL_MICRO_TOX_SECTION;
...
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_SOIL_MICRO_TOX_SECTION.DocumentTypeType;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_SOIL_MICRO_TOX_SECTION.EndpointStudyRecord;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_SOIL_MICRO_TOX_SECTION.EndpointStudyRecord.ScientificPart.ECSOILMICROTOX.REFERENCE.Set;

public class StudyRecordConverter
	extends
	ECOTOXStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_SOIL_MICRO_TOX_SECTION.EndpointStudyRecord> {
	...
	if (super.transform2record(unmarshalled, record) == null)
	    return null;
	eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_SOIL_MICRO_TOX_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled
		.getScientificPart();
	...
	if (sciPart.getECSOILMICROTOX().getGUIDELINE() != null)
	    for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_SOIL_MICRO_TOX_SECTION.EndpointStudyRecord.ScientificPart.ECSOILMICROTOX.GUIDELINE.Set set : sciPart
	...
	if (sciPart.getECSOILMICROTOX().getEFFCONC() != null
	    ...
	    for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_SOIL_MICRO_TOX_SECTION.EndpointStudyRecord.ScientificPart.ECSOILMICROTOX.EFFCONC.Set set : sciPart
