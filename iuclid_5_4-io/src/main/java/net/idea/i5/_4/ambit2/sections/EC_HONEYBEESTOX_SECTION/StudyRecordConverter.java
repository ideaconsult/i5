package net.idea.i5._4.ambit2.sections.EC_HONEYBEESTOX_SECTION;
...
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_HONEYBEESTOX_SECTION.DocumentTypeType;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_HONEYBEESTOX_SECTION.EndpointStudyRecord;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_HONEYBEESTOX_SECTION.EndpointStudyRecord.ScientificPart.ECHONEYBEESTOX.REFERENCE.Set;
...
public class StudyRecordConverter
	extends
	ECOTOXStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_HONEYBEESTOX_SECTION.EndpointStudyRecord> {
	...
	if (super.transform2record(unmarshalled, record) == null)
	    return null;
	eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_HONEYBEESTOX_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled
		.getScientificPart();
	...
	if (sciPart.getECHONEYBEESTOX().getGUIDELINE() != null)
	    for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_HONEYBEESTOX_SECTION.EndpointStudyRecord.ScientificPart.ECHONEYBEESTOX.GUIDELINE.Set set : sciPart
	...
	if (sciPart.getECHONEYBEESTOX().getEFFCONC() != null
	    ...
	    for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_HONEYBEESTOX_SECTION.EndpointStudyRecord.ScientificPart.ECHONEYBEESTOX.EFFCONC.Set set : sciPart
