...
public class StudyRecordConverter extends ENVFATEStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EN_BIOACCU_TERR_SECTION.EndpointStudyRecord>{
	...
	public IStructureRecord transform2record(EndpointStudyRecord unmarshalled, SubstanceRecord record) throws AmbitException {
		...
		eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EN_BIOACCU_TERR_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled.getScientificPart();
		...
		if (sciPart.getENBIOACCUTERR().getBCF()!=null) {
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EN_BIOACCU_TERR_SECTION.EndpointStudyRecord.ScientificPart.ENBIOACCUTERR.BCF.Set set : sciPart.getENBIOACCUTERR().getBCF().getSet()) {
