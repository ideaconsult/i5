package net.idea.i5._4.ambit2.sections.TO_CARCINOGENICITY_SECTION;
...
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_CARCINOGENICITY_SECTION.DocumentTypeType;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_CARCINOGENICITY_SECTION.EndpointStudyRecord;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_CARCINOGENICITY_SECTION.EndpointStudyRecord.ScientificPart.TOCARCINOGENICITY.GUIDELINE.Set;
...
public class StudyRecordConverter extends TOXStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_CARCINOGENICITY_SECTION.EndpointStudyRecord>{
	...
	protected void parseReference(EndpointStudyRecord unmarshalled, ProtocolApplication papp) throws QACriteriaException {
		...
		if (unmarshalled.getScientificPart().getTOCARCINOGENICITY().getREFERENCE() != null)
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_CARCINOGENICITY_SECTION.EndpointStudyRecord.ScientificPart.TOCARCINOGENICITY.REFERENCE.Set set : unmarshalled.getScientificPart().getTOCARCINOGENICITY().getREFERENCE().getSet()) {
				try {
	...
	public IStructureRecord transform2record(EndpointStudyRecord unmarshalled, SubstanceRecord record) throws AmbitException {
		...
		eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_CARCINOGENICITY_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled.getScientificPart();
		...
		*/
		...
		for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_CARCINOGENICITY_SECTION.EndpointStudyRecord.ScientificPart.TOCARCINOGENICITY.DOSES.Set set : sciPart.getTOCARCINOGENICITY().getDOSES().getSet()) {
		...
		if (sciPart.getTOCARCINOGENICITY().getEFFLEVEL() != null)
			for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.TO_CARCINOGENICITY_SECTION.EndpointStudyRecord.ScientificPart.TOCARCINOGENICITY.EFFLEVEL.Set set : sciPart.getTOCARCINOGENICITY().getEFFLEVEL().getSet()) {
