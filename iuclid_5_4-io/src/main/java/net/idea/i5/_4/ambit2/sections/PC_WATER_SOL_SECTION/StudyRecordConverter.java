package net.idea.i5._4.ambit2.sections.PC_WATER_SOL_SECTION;
...
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.PC_WATER_SOL_SECTION.DocumentTypeType;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.PC_WATER_SOL_SECTION.EndpointStudyRecord;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.PC_WATER_SOL_SECTION.EndpointStudyRecord.ScientificPart;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.PC_WATER_SOL_SECTION.EndpointStudyRecord.ScientificPart.PCWATERSOL.REFERENCE.Set;
...
public class StudyRecordConverter
	extends
	PChemStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.PC_WATER_SOL_SECTION.EndpointStudyRecord, IParams, IParams> {
	...
	if (super.transform2record(unmarshalled, record) == null)
	    return null;
	eu.europa.echa.schemas.iuclid5._20120101.studyrecord.PC_WATER_SOL_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled
		.getScientificPart();
	...
	if (sciPart.getPCWATERSOL().getWATERSOL() != null)
	    for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.PC_WATER_SOL_SECTION.EndpointStudyRecord.ScientificPart.PCWATERSOL.WATERSOL.Set set : sciPart
