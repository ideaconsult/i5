package net.idea.i5._4.ambit2.sections.EC_ALGAETOX_SECTION;
...
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_ALGAETOX_SECTION.DocumentTypeType;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_ALGAETOX_SECTION.EndpointStudyRecord;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_ALGAETOX_SECTION.EndpointStudyRecord.ScientificPart.ECALGAETOX.REFERENCE.Set;
...
public class StudyRecordConverter
	extends
	ECOTOXStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_ALGAETOX_SECTION.EndpointStudyRecord> {
	...
	eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_ALGAETOX_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled
		.getScientificPart();
	...
	if (sciPart.getECALGAETOX().getGUIDELINE() != null)
	    for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_ALGAETOX_SECTION.EndpointStudyRecord.ScientificPart.ECALGAETOX.GUIDELINE.Set set : sciPart
	...
	if (sciPart.getECALGAETOX().getEFFCONC() != null && sciPart.getECALGAETOX().getEFFCONC().getSet() != null)
	    for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EC_ALGAETOX_SECTION.EndpointStudyRecord.ScientificPart.ECALGAETOX.EFFCONC.Set set : sciPart
