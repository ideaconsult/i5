package net.idea.i5._4.ambit2.sections.EN_HENRY_LAW_SECTION;
...
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EN_HENRY_LAW_SECTION.DocumentTypeType;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EN_HENRY_LAW_SECTION.EndpointStudyRecord;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EN_HENRY_LAW_SECTION.EndpointStudyRecord.ScientificPart;
import eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EN_HENRY_LAW_SECTION.EndpointStudyRecord.ScientificPart.ENHENRYLAW.REFERENCE.Set;
...
public class StudyRecordConverter
	extends
	ENVFATEStudyRecordConvertor<eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EN_HENRY_LAW_SECTION.EndpointStudyRecord> {
	...
	if (super.transform2record(unmarshalled, record) == null)
	    return null;
	eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EN_HENRY_LAW_SECTION.EndpointStudyRecord.ScientificPart sciPart = unmarshalled
		.getScientificPart();
	...
	if (sciPart.getENHENRYLAW().getHENRYSLAW() != null) {
	    for (eu.europa.echa.schemas.iuclid5._20120101.studyrecord.EN_HENRY_LAW_SECTION.EndpointStudyRecord.ScientificPart.ENHENRYLAW.HENRYSLAW.Set set : sciPart
