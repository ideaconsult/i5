...
public class SubstanceTest {
	...
	public void test_i5d_5() throws Exception {
		...
		InputStream in = SubstanceTest.class.getClassLoader()
	...
	public void test_i5d_5_acutetox() throws Exception {
		...
		for (String f : tox) {
			...
			I5_ROOT_OBJECTS rootObject = rootObjectVerifier.process(in);
			if (rootObject != null) {
				in = SubstanceTest.class.getClassLoader().getResourceAsStream(
						test);
	...
	public void test_i5d_5_rtd_oral() throws Exception {
		...
		String[] pc = new String[] { "IUC4-953e0e9f-c417-3bc3-999c-011f4f097b4d_0.i5d" };
		for (String f : pc) {

			String test = String.format(
					"net/idea/i5/_5/substance/i5d/rtd_oral/%s", f);
			System.out.println("\n>>>>>\t" + test);
			I5ObjectVerifier rootObjectVerifier = new I5ObjectVerifier();
			InputStream in = SubstanceTest.class.getClassLoader()
					.getResourceAsStream(test);
	...
	public void test_i5d_5_repro() throws Exception {
		...
		String[] pc = new String[] { "IUC4-dbbac947-303e-3a99-be66-9b39d429a138_0.i5d" };
		for (String f : pc) {

			String test = String.format(
					"net/idea/i5/_5/substance/i5d/repro/%s", f);
			System.out.println("\n>>>>>\t" + test);
			I5ObjectVerifier rootObjectVerifier = new I5ObjectVerifier();
			InputStream in = SubstanceTest.class.getClassLoader()
					.getResourceAsStream(test);
	...
	public void test_i5d_skinsens() throws Exception {
		...
		String[] pc = new String[] { "IUC4-aa3469aa-5a18-3b40-a217-ea5a468aebc5_0.i5d" };
		for (String f : pc) {

			String test = String.format(
					"net/idea/i5/_5/substance/i5d/skinsens/%s", f);
			System.out.println("\n>>>>>\t" + test);
			I5ObjectVerifier rootObjectVerifier = new I5ObjectVerifier();
			InputStream in = SubstanceTest.class.getClassLoader()
					.getResourceAsStream(test);
	...
	public void test_i5d_gentox_invitro() throws Exception {
		...
		String[] pc = new String[] { "IUC4-2dc334eb-c0a6-36bd-8412-a6b20d80d912_0.i5d" };
		for (String f : pc) {

			String test = String.format(
					"net/idea/i5/_5/substance/i5d/gentox_invitro/%s", f);
			System.out.println("\n>>>>>\t" + test);
			I5ObjectVerifier rootObjectVerifier = new I5ObjectVerifier();
			InputStream in = SubstanceTest.class.getClassLoader()
					.getResourceAsStream(test);
	...
	public void test_i5d_skinirritation() throws Exception {
		...
		String[] pc = new String[] { "IUC4-de71a66c-3f4d-3439-ac91-1ddbdf461793_0.i5d" };
		for (String f : pc) {

			String test = String.format(
					"net/idea/i5/_5/substance/i5d/skinirritation/%s", f);
			System.out.println("\n>>>>>\t" + test);
			I5ObjectVerifier rootObjectVerifier = new I5ObjectVerifier();
			InputStream in = SubstanceTest.class.getClassLoader()
					.getResourceAsStream(test);
	...
	public void test_i5d_5_physchem() throws Exception {
		...
		for (String f : pc) {
			...
			String test = String.format(
					"net/idea/i5/_5/substance/i5d/physchem/%s", f);
			System.out.println("\n>>>>>\t" + test);
			I5ObjectVerifier rootObjectVerifier = new I5ObjectVerifier();
			InputStream in = SubstanceTest.class.getClassLoader()
					.getResourceAsStream(test);
	...
	public void test_i5d_5_meltingpoint() throws Exception {
		...
		String[] pc = new String[] { "IUC4-82dbd0ed-4c85-3bcc-b3a2-19822ccd099b_0.i5d" };
		for (String f : pc) {

			String test = String.format(
					"net/idea/i5/_5/substance/i5d/melting/%s", f);
			System.out.println("\n>>>>>\t" + test);
			I5ObjectVerifier rootObjectVerifier = new I5ObjectVerifier();
			InputStream in = SubstanceTest.class.getClassLoader()
					.getResourceAsStream(test);
	...
	public void test_i5d_5_watersol() throws Exception {
		...
		for (String f : pc) {
			...
			String test = String.format(
					"net/idea/i5/_5/substance/i5d/watersol/%s", f);
			System.out.println("\n>>>>>\t" + test);
			I5ObjectVerifier rootObjectVerifier = new I5ObjectVerifier();
			InputStream in = SubstanceTest.class.getClassLoader()
					.getResourceAsStream(test);
	...
	public void test_i5d_5_phototrans() throws Exception {
		...
		for (String f : pc) {
			...
			String test = String.format(
					"net/idea/i5/_5/substance/i5d/phototrans/%s", f);
			System.out.println("\n>>>>>\t" + test);
			I5ObjectVerifier rootObjectVerifier = new I5ObjectVerifier();
			InputStream in = SubstanceTest.class.getClassLoader()
					.getResourceAsStream(test);
	...
	public void test_i5d_5_biodegsoil() throws Exception {
		...
		for (String f : pc) {
			...
			String test = String.format(
					"net/idea/i5/_5/substance/i5d/biodeg_soil/%s", f);
			System.out.println("\n>>>>>\t" + test);
			I5ObjectVerifier rootObjectVerifier = new I5ObjectVerifier();
			InputStream in = SubstanceTest.class.getClassLoader()
					.getResourceAsStream(test);
	...
	/*
	 * >>>>>
	 * net/idea/i5/_5/substance/i5z/IUC4-efdb21bb-e79f-3286-a988-b6f6944d3734
	 * /IUC4-d5f14d83-b2b5-38ac-9f2a-8134ce000cc8_0.i5d Endpoint Short-term
	 * toxicity to fish, IUC4#1/Ch.4.1 Document UUID
	 * IUC4-d5f14d83-b2b5-38ac-9f2a-8134ce000cc8/0 Substance UUID (company
	 * specific) IUC4-efdb21bb-e79f-3286-a988-b6f6944d3734/0 Substance
	 * description formaldehyde (IUC4 DSN 52) Guideline according to EU Method
	 * C.1 (Acute Toxicity for Fish) Organism 302 Cyprinus carpio Endpoint 926
	 * LC50 Qualifier null null Value 2 1976 h
	 */
	@Test
	...
	public void test_i5d_5_biodeg() throws Exception {
		String[] fish = new String[] { "IUC4-1d75f01c-3b2b-35f5-84f1-ce23e22b6c73_0.i5d" };
		for (String f : fish) {
			String test = String.format(
					"net/idea/i5/_5/substance/i5d/biodeg/%s", f);
			System.out.println("\n>>>>>\t" + test);
			I5ObjectVerifier rootObjectVerifier = new I5ObjectVerifier();
	...
	public void test_i5d_4() throws Exception {
		...
		I5_ROOT_OBJECTS rootObject = rootObjectVerifier
				.process(new FileInputStream(new File(url.getFile())));
		if (rootObject != null) {
			InputStream in = SubstanceTest.class.getClassLoader()
					.getResourceAsStream(test);
			test_i5d(in, rootObject.getContextPath());
	...
	protected void test_i5d(InputStream in, String contextPath)
			throws Exception {
		test_i5d(in, contextPath, true);
	}

	protected void test_i5d(InputStream in, String contextPath,
			boolean substance) throws Exception {

		Assert.assertNotNull(in);
		int count = 0;
		try {
			I5DReader reader = new I5DReader("test", in, contextPath,
					new QASettings());
			...
			while (reader.hasNext()) {
				...
				if (substance) {
					for (IStructureRelation relation : substanceRecord
							.getRelatedStructures()) {
						System.out.print(relation.getRelationType());
						System.out.println(relation.getRelation());

						System.out.println(relation.getFirstStructure()
								.getContent());
						System.out
								.println(relation.getFirstStructure()
										.getRecordProperty(
												Property.getI5UUIDInstance()));
						System.out.println(relation.getSecondStructure()
								.getContent());
						System.out
								.println(relation.getSecondStructure()
										.getRecordProperty(
												Property.getI5UUIDInstance()));
						System.out.println();
					}
					System.out.println(substanceRecord
							.toJSON("http://localhost:8080/ambit2"));
					if (substanceRecord.getMeasurements() != null)
						for (ProtocolApplication papp : substanceRecord
								.getMeasurements()) {
							System.out.println(papp.toString());
						}

				} else {
					Assert.assertNotNull(((SubstanceRecord) record)
							.getSubstanceUUID());
				}
			}
		} finally {
	...
	public void test_i5z_5() throws Exception {
		...
		URL url = SubstanceTest.class.getClassLoader().getResource(test);
		Assert.assertEquals(602, unmarshall_i5z(new File(url.getFile()), 602));
	}
	...
	public void test_i5z_5_fishtox() throws Exception {
		...
		String test = "net/idea/i5/_5/substance/i5z/IUC4-efdb21bb-e79f-3286-a988-b6f6944d3734.i5z";
		// String test =
		// "F:/nina/Ideaconsult/Projects/2013 - LRI AMBIT/AMBIT-LRI/IUCLID example for 4 endpoints.i5z";
		URL url = SubstanceTest.class.getClassLoader().getResource(test);
		...
		try {
			...
			while (reader.hasNext()) {
				...
				if (next instanceof SubstanceRecord) {
					Assert.assertNotNull(((SubstanceRecord) next)
							.getSubstanceUUID());
					//Assert.assertNotNull(((SubstanceRecord) next).getContent());
					if (((SubstanceRecord) next).getRelatedStructures() != null)
						for (CompositionRelation r : ((SubstanceRecord) next)
								.getRelatedStructures()) {
	...
	public static void main(String[] args) {
		...
		for (File file : dir.listFiles(new FilenameFilter() {
			...
			try {
				...
				System.out.println(String.format("Read %d in %d msec", records,
						(System.currentTimeMillis() - started)));
			}

		}
		System.out.println(String.format("OK %d\tErrors %d\t%d", ok, err,
