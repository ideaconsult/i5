...
public class RegulatoryProgrammeIdentifiers {

    protected List<RegulatoryProgrammeIdentifiersEntry> entry;
     ...
     * {@link RegulatoryProgrammeIdentifiersEntry }
     * 
     * 
     */
    public List<RegulatoryProgrammeIdentifiersEntry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<RegulatoryProgrammeIdentifiersEntry>();
        }
        return this.entry;
    }
