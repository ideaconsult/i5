...
public class AttachedJustification {

    protected List<AttachedJustificationEntry> entry;
     ...
     * {@link AttachedJustificationEntry }
     * 
     * 
     */
    public List<AttachedJustificationEntry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<AttachedJustificationEntry>();
        }
        return this.entry;
    }
