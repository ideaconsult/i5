...
public class P0Efflevel {

    protected List<EffectLevelsP0Entry> entry;
     ...
     * {@link EffectLevelsP0Entry }
     * 
     * 
     */
    public List<EffectLevelsP0Entry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<EffectLevelsP0Entry>();
        }
        return this.entry;
    }
