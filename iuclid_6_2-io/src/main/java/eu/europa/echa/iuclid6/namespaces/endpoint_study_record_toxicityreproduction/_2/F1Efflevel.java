...
public class F1Efflevel {

    protected List<EffectLevelsF1Entry> entry;
     ...
     * {@link EffectLevelsF1Entry }
     * 
     * 
     */
    public List<EffectLevelsF1Entry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<EffectLevelsF1Entry>();
        }
        return this.entry;
    }
