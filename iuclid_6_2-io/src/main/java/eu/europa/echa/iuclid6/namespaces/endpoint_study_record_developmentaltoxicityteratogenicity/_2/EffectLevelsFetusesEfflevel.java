...
public class EffectLevelsFetusesEfflevel {

    protected List<EffectLevelsFetusesEfflevelEntry> entry;
     ...
     * {@link EffectLevelsFetusesEfflevelEntry }
     * 
     * 
     */
    public List<EffectLevelsFetusesEfflevelEntry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<EffectLevelsFetusesEfflevelEntry>();
        }
        return this.entry;
    }
