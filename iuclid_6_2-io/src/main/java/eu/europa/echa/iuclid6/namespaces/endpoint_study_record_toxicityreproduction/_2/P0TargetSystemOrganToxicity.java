...
public class P0TargetSystemOrganToxicity {

    protected List<TargetSystemOrganToxicityP0Entry> entry;
     ...
     * {@link TargetSystemOrganToxicityP0Entry }
     * 
     * 
     */
    public List<TargetSystemOrganToxicityP0Entry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<TargetSystemOrganToxicityP0Entry>();
        }
        return this.entry;
    }
