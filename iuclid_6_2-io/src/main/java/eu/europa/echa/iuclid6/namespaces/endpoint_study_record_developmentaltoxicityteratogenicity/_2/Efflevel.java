...
public class Efflevel {

    protected List<EffectLevelsMaternalAnimalsEfflevelEntry> entry;
     ...
     * {@link EffectLevelsMaternalAnimalsEfflevelEntry }
     * 
     * 
     */
    public List<EffectLevelsMaternalAnimalsEfflevelEntry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<EffectLevelsMaternalAnimalsEfflevelEntry>();
        }
        return this.entry;
    }
