...
public class SupportingInformation {
    ...
    protected List<SupportingInformationEntry> entry;
     ...
     * {@link SupportingInformationEntry }
     * 
     * 
     */
    public List<SupportingInformationEntry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<SupportingInformationEntry>();
        }
        return this.entry;
    }
