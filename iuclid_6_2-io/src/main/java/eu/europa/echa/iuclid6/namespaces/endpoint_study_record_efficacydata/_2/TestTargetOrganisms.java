...
public class TestTargetOrganisms {

    protected List<TestTargetOrganismsEntry> entry;
     ...
     * {@link TestTargetOrganismsEntry }
     * 
     * 
     */
    public List<TestTargetOrganismsEntry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<TestTargetOrganismsEntry>();
        }
        return this.entry;
    }
