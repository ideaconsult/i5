 ...
 *                   &lt;element name="TypeOfMedium" type="{http://iuclid6.echa.europa.eu/namespaces/platform-fields/v1}picklistField"/>
...
public class ENDPOINTSTUDYRECORDBiotransformationAndKinetics {
    ...
    public static class MaterialsAndMethods {
        ...
        protected ENDPOINTSTUDYRECORDBiotransformationAndKinetics.MaterialsAndMethods.Guideline guideline;
        ...
        @XmlElement(name = "TypeOfMedium", required = true)
        protected PicklistField typeOfMedium;
         ...
         * @return
         *     possible object is
         *     {@link ENDPOINTSTUDYRECORDBiotransformationAndKinetics.MaterialsAndMethods.Guideline }
         *     
         */
        public ENDPOINTSTUDYRECORDBiotransformationAndKinetics.MaterialsAndMethods.Guideline getGuideline() {
            return guideline;
        }
         ...
         *     
         */
        public void setGuideline(ENDPOINTSTUDYRECORDBiotransformationAndKinetics.MaterialsAndMethods.Guideline value) {
         ...
         *     
         */
        public PicklistField getTypeOfMedium() {
            return typeOfMedium;
        }
         ...
         *     
         */
        public void setTypeOfMedium(PicklistField value) {
        ...
        public static class Guideline {
            ...
            protected List<ENDPOINTSTUDYRECORDBiotransformationAndKinetics.MaterialsAndMethods.Guideline.Entry> entry;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link ENDPOINTSTUDYRECORDBiotransformationAndKinetics.MaterialsAndMethods.Guideline.Entry }
             * 
             * 
             */
            public List<ENDPOINTSTUDYRECORDBiotransformationAndKinetics.MaterialsAndMethods.Guideline.Entry> getEntry() {
                if (entry == null) {
                    entry = new ArrayList<ENDPOINTSTUDYRECORDBiotransformationAndKinetics.MaterialsAndMethods.Guideline.Entry>();
                }
                return this.entry;
            }
