...
public class F2TargetSystemOrganToxicity {

    protected List<TargetSystemOrganToxicityF2Entry> entry;
     ...
     * {@link TargetSystemOrganToxicityF2Entry }
     * 
     * 
     */
    public List<TargetSystemOrganToxicityF2Entry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<TargetSystemOrganToxicityF2Entry>();
        }
        return this.entry;
    }
