...
public class AttachedDescription {
    ...
    protected List<AttachedDescriptionEntry> entry;
     ...
     * {@link AttachedDescriptionEntry }
     * 
     * 
     */
    public List<AttachedDescriptionEntry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<AttachedDescriptionEntry>();
        }
        return this.entry;
    }
