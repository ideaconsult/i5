...
public class TargetSystemOrganToxicity2 {

    protected List<TargetSystemOrganToxicityEntry> entry;
     ...
     * {@link TargetSystemOrganToxicityEntry }
     * 
     * 
     */
    public List<TargetSystemOrganToxicityEntry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<TargetSystemOrganToxicityEntry>();
        }
        return this.entry;
    }
