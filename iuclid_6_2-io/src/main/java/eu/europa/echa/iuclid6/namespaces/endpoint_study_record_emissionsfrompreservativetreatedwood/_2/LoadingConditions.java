...
public class LoadingConditions {
    ...
    protected List<LoadingConditionsEntry> entry;
     ...
     * {@link LoadingConditionsEntry }
     * 
     * 
     */
    public List<LoadingConditionsEntry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<LoadingConditionsEntry>();
        }
        return this.entry;
    }
