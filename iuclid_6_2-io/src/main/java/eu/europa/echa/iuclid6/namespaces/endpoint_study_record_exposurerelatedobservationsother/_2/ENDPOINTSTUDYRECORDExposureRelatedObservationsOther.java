 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="TypeOfStudyInformation" type="{http://iuclid6.echa.europa.eu/namespaces/platform-fields/v1}textFieldMultiLine"/>
...
public class ENDPOINTSTUDYRECORDExposureRelatedObservationsOther {
    ...
    public static class MaterialsAndMethods {
        ...
        @XmlElement(name = "TypeOfStudyInformation", required = true)
        protected String typeOfStudyInformation;
        @XmlElement(name = "EndpointAddressed")
        protected List<PicklistField> endpointAddressed;
        @XmlElement(name = "Guideline", required = true)
        protected ENDPOINTSTUDYRECORDExposureRelatedObservationsOther.MaterialsAndMethods.Guideline guideline;
         ...
         *     
         */
        public String getTypeOfStudyInformation() {
            return typeOfStudyInformation;
        }

        /**
         * Sets the value of the typeOfStudyInformation property.
         * 
         * @param value
         *     allowed object is
         *     {@link String }
         *     
         */
        public void setTypeOfStudyInformation(String value) {
            this.typeOfStudyInformation = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link ENDPOINTSTUDYRECORDExposureRelatedObservationsOther.MaterialsAndMethods.Guideline }
         *     
         */
        public ENDPOINTSTUDYRECORDExposureRelatedObservationsOther.MaterialsAndMethods.Guideline getGuideline() {
            return guideline;
        }
         ...
         *     
         */
        public void setGuideline(ENDPOINTSTUDYRECORDExposureRelatedObservationsOther.MaterialsAndMethods.Guideline value) {
        ...
        public static class Guideline {
            ...
            protected List<ENDPOINTSTUDYRECORDExposureRelatedObservationsOther.MaterialsAndMethods.Guideline.Entry> entry;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link ENDPOINTSTUDYRECORDExposureRelatedObservationsOther.MaterialsAndMethods.Guideline.Entry }
             * 
             * 
             */
            public List<ENDPOINTSTUDYRECORDExposureRelatedObservationsOther.MaterialsAndMethods.Guideline.Entry> getEntry() {
                if (entry == null) {
                    entry = new ArrayList<ENDPOINTSTUDYRECORDExposureRelatedObservationsOther.MaterialsAndMethods.Guideline.Entry>();
                }
                return this.entry;
            }
