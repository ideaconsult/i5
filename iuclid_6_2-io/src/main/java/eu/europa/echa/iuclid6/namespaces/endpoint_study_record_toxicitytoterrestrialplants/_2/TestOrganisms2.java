...
public class TestOrganisms2 {

    protected List<TestOrganismsEntry> entry;
     ...
     * {@link TestOrganismsEntry }
     * 
     * 
     */
    public List<TestOrganismsEntry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<TestOrganismsEntry>();
        }
        return this.entry;
    }
