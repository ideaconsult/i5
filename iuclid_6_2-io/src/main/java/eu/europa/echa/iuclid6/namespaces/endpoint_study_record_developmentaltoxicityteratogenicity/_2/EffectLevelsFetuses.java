...
public class EffectLevelsFetuses {

    @XmlElement(name = "Efflevel", required = true)
    protected EffectLevelsFetusesEfflevel efflevel;
     ...
     * @return
     *     possible object is
     *     {@link EffectLevelsFetusesEfflevel }
     *     
     */
    public EffectLevelsFetusesEfflevel getEfflevel() {
        return efflevel;
    }
     ...
     *     
     */
    public void setEfflevel(EffectLevelsFetusesEfflevel value) {
        this.efflevel = value;
    }
