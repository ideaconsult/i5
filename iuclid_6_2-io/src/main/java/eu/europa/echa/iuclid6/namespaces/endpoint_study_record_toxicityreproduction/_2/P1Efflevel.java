...
public class P1Efflevel {

    protected List<EffectLevelsP1Entry> entry;
     ...
     * {@link EffectLevelsP1Entry }
     * 
     * 
     */
    public List<EffectLevelsP1Entry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<EffectLevelsP1Entry>();
        }
        return this.entry;
    }
