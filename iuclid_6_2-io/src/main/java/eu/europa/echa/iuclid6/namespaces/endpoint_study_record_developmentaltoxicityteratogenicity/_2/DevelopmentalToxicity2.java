...
public class DevelopmentalToxicity2 {

    protected List<DevelopmentalToxicityEntry> entry;
     ...
     * {@link DevelopmentalToxicityEntry }
     * 
     * 
     */
    public List<DevelopmentalToxicityEntry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<DevelopmentalToxicityEntry>();
        }
        return this.entry;
    }
