...
public class F2Efflevel {

    protected List<EffectLevelsF2Entry> entry;
     ...
     * {@link EffectLevelsF2Entry }
     * 
     * 
     */
    public List<EffectLevelsF2Entry> getEntry() {
        if (entry == null) {
            entry = new ArrayList<EffectLevelsF2Entry>();
        }
        return this.entry;
    }
