...
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_hydrolysis._2.ENDPOINTSTUDYRECORDHydrolysis;
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_hydrolysis._2.ENDPOINTSTUDYRECORDHydrolysis.ResultsAndDiscussion.DissipationHalfLifeOfParentCompound.Entry;
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_hydrolysis._2.ENDPOINTSTUDYRECORDHydrolysis.ResultsAndDiscussion.DissipationHalfLifeOfParentCompound.Entry.Temp;
	...
	public void assignEffectLevels(ProtocolApplication papp, ENDPOINTSTUDYRECORDHydrolysis studyrecord) {
		if (studyrecord.getResultsAndDiscussion().getDissipationHalfLifeOfParentCompound() != null)
			for (Entry e : studyrecord.getResultsAndDiscussion().getDissipationHalfLifeOfParentCompound().getEntry()) {
				...
				// ph
				effect.getConditions().put(I5CONSTANTS.pH, e.getPh() == null ? null : e.getPh().doubleValue());
