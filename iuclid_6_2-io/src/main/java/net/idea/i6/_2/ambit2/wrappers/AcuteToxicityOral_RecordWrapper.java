...
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_acutetoxicityoral._2.ENDPOINTSTUDYRECORDAcuteToxicityOral;
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_acutetoxicityoral._2.ENDPOINTSTUDYRECORDAcuteToxicityOral.ResultsAndDiscussion.EffectLevels.Entry;
...
public class AcuteToxicityOral_RecordWrapper extends EndpointStudyRecordWrapper<ENDPOINTSTUDYRECORDAcuteToxicityOral> {
	...
	public void assignEffectLevels(ProtocolApplication papp, ENDPOINTSTUDYRECORDAcuteToxicityOral studyrecord) {
		if (studyrecord.getResultsAndDiscussion().getEffectLevels()==null) return;
	...
	public void assignInterpretationResult(ProtocolApplication papp, ENDPOINTSTUDYRECORDAcuteToxicityOral studyRecord) {
		papp.setInterpretationResult(p2Value(studyRecord.getApplicantSummaryAndConclusion().getInterpretationOfResults()));
		papp.setInterpretationCriteria(studyRecord.getApplicantSummaryAndConclusion().getInterpretationOfResults().getRemarks());
	}
