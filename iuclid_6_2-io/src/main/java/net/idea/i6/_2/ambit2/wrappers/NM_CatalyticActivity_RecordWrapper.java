...
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_catalyticactivity._2.ENDPOINTSTUDYRECORDCatalyticActivity;
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_catalyticactivity._2.ENDPOINTSTUDYRECORDCatalyticActivity.ResultsAndDiscussion.PhotocatalyticActivity.Entry;
...
public class NM_CatalyticActivity_RecordWrapper extends EndpointStudyRecordWrapper<ENDPOINTSTUDYRECORDCatalyticActivity> {
	...
	public void assignEffectLevels(ProtocolApplication papp, ENDPOINTSTUDYRECORDCatalyticActivity studyrecord) {
		...
		for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_catalyticactivity._2.ENDPOINTSTUDYRECORDCatalyticActivity.ResultsAndDiscussion.Frequency.Entry entry : studyrecord.getResultsAndDiscussion().getFrequency().getEntry()) {
