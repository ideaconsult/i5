...
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_toxicitytosoilmicroorganisms._2.ENDPOINTSTUDYRECORDToxicityToSoilMicroorganisms;
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_toxicitytosoilmicroorganisms._2.ENDPOINTSTUDYRECORDToxicityToSoilMicroorganisms.ResultsAndDiscussion.EffectConcentrations.Entry.Duration;
import eu.europa.echa.iuclid6.namespaces.platform_container.v1.Document;
import net.idea.i5.io.I5CONSTANTS;
import net.idea.i6._2.ambit2.EndpointStudyRecordWrapper;

public class ToxicityToSoilMicroorganisms_RecordWrapper
		extends EndpointStudyRecordWrapper<ENDPOINTSTUDYRECORDToxicityToSoilMicroorganisms> {

	public ToxicityToSoilMicroorganisms_RecordWrapper(Document doc) throws Exception {
		super(doc);
	}
	...
	public void assignEffectLevels(ProtocolApplication papp,
		...
		for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_toxicitytosoilmicroorganisms._2.ENDPOINTSTUDYRECORDToxicityToSoilMicroorganisms.ResultsAndDiscussion.EffectConcentrations.Entry e : studyrecord
