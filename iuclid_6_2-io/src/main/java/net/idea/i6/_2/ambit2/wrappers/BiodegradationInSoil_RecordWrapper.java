...
public class BiodegradationInSoil_RecordWrapper
	...
	public void assignEffectLevels(ProtocolApplication papp, ENDPOINTSTUDYRECORDBiodegradationInSoil studyrecord) {
		if (studyrecord.getMaterialsAndMethods().getStudyDesign().getSoilProperties()!=null)
			for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_biodegradationinsoil._2.ENDPOINTSTUDYRECORDBiodegradationInSoil.MaterialsAndMethods.StudyDesign.SoilProperties.Entry e : studyrecord.getMaterialsAndMethods().getStudyDesign().getSoilProperties().getEntry()) {
		...
		if (studyrecord.getResultsAndDiscussion().getHalfLifeOfParentCompound() != null)
			for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_biodegradationinsoil._2.ENDPOINTSTUDYRECORDBiodegradationInSoil.ResultsAndDiscussion.HalfLifeOfParentCompound.Entry e : studyrecord
