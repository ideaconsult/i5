...
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_pourdensity._2.ENDPOINTSTUDYRECORDPourDensity;
...
public class NM_PourDensity_RecordWrapper extends EndpointStudyRecordWrapper<ENDPOINTSTUDYRECORDPourDensity> {
	...
	public void assignEffectLevels(ProtocolApplication papp, ENDPOINTSTUDYRECORDPourDensity studyrecord) {
		...
		for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_pourdensity._2.ENDPOINTSTUDYRECORDPourDensity.ResultsAndDiscussion.PourDensity.Entry entry : studyrecord.getResultsAndDiscussion().getPourDensity().getEntry()) {
