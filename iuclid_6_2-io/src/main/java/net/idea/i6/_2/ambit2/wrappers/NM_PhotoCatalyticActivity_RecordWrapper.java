...
import eu.europa.echa.iuclid6.namespaces.endpoint_study_record_photocatalyticactivity._2.ENDPOINTSTUDYRECORDPhotocatalyticActivity;
...
public class NM_PhotoCatalyticActivity_RecordWrapper extends EndpointStudyRecordWrapper<ENDPOINTSTUDYRECORDPhotocatalyticActivity> {
	...
	public void assignEffectLevels(ProtocolApplication papp, ENDPOINTSTUDYRECORDPhotocatalyticActivity studyrecord) {
		...
		for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_photocatalyticactivity._2.ENDPOINTSTUDYRECORDPhotocatalyticActivity.ResultsAndDiscussion.PhotocatalyticActivity.Entry entry : studyrecord.getResultsAndDiscussion().getPhotocatalyticActivity().getEntry()) {
		...
		for (eu.europa.echa.iuclid6.namespaces.endpoint_study_record_photocatalyticactivity._2.ENDPOINTSTUDYRECORDPhotocatalyticActivity.ResultsAndDiscussion.TurnOverFrequency.Entry entry : studyrecord.getResultsAndDiscussion().getTurnOverFrequency().getEntry()) {
