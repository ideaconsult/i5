...
public class SessionClient extends I5AbstractClient {
	...
	@Override
	protected List<IIdentifiableResource<IIdentifier>> get(IIdentifier url,
	...
	public String login(String username, String password) throws Exception {
		String xml = String.format(
				loadXML("net/idea/i5/cli/session/login.xml"), username,
	...
	public void logout(String token) throws Exception {
		String xml = String.format(
				loadXML("net/idea/i5/cli/session/logout.xml"), token);
		post(xml, "Logout");
	}
	...
	protected String processXML(InputStream in) throws RestException,
			IOException {
		String session = null;
